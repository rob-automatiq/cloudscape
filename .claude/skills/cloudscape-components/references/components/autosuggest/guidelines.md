...
> Source: https://cloudscape.design/components/autosuggest/ (fetched 2026-09-24)

Autosuggest enables users to choose from a list of suggestions.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/autosuggest)
...
The autosuggest component is controlled. Set the `value` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of our components.
...
| findOptionsContainer | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Use this element to scroll through the list of options | - | OptionWrapper 
...
| findSuffix | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - | AutosuggestDropdownWrapper 
...
| findOptionsContainer | [ElementWrapper](../../get-started/testing/core-classes.md) | Use this element to scroll through the list of options | - | OptionWrapper 
...
- Use autosuggest if the user can input any value in the field to  proceed. If the user must select one option from a list in order to proceed, use [select](../select/guidelines.md)  .
- Every input field should have a label. Use the [form field](../form-field/guidelines.md)   for  labeling your inputs.
...
- #### Loading suggestions
  ...
  - [Static suggestions](guidelines.md)     - default    

    - Use this when the full list of suggestions takes only one API call to be fetched.
  - [Asynchronously fetched suggestions](guidelines.md)    
...
- #### Suggestion metadata - optional
  ...
  - Icons are placed on the left side of the suggestion. View available icons in [Iconography](../../foundation/visual-foundation/iconography.md)    .
...
- For additional accessibility guidelines, follow the [select](../select/guidelines.md)   component guidelines.
