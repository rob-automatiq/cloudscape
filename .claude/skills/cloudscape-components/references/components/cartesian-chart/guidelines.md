...
> Source: https://cloudscape.design/components/cartesian-chart/ (fetched 2026-09-24)
...
| findSeries | Array<[ElementWrapper](https://cloudscape.design/)> | Finds series elements. Use this to assert the number of visible series. | - |
| findTooltip | [CartesianChartTooltipWrapper](https://cloudscape.design/) &#124; null | Finds chart's tooltip when visible. | - |
| findXAxisTitle | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds visible title of the x axis. | - |
| findYAxisTitle | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds visible title of the y axis. | __0:Optional axis ID to target a specific y axis title (e.g. "secondary"). | BaseChartFilterWrapper 
...
| findRetryButton | [ButtonWrapper](../button/guidelines.md) &#124; null | Finds no-data retry button when the chart is in error state, and uses the default recovery button. | - | CartesianChartTooltipWrapper 
...
| findPoints | Array<[PointDetailsItemWrapper](https://cloudscape.design/)> | Finds matched tooltip points. | - | PointDetailsItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDescription | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds tooltip point description when defined. | - |
| findKey | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | Finds tooltip point key. | - |
| findSubItems | Array<[PointDetailsSubItemWrapper](https://cloudscape.design/)> | Finds point sub-items when defined. | - |
| findValue | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | Finds tooltip point value. | - | PointDetailsSubItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDescription | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds tooltip point description when defined. | - |
| findKey | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | Finds tooltip point key. | - |
| findValue | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | Finds tooltip point value. | - |
...
| findSeries | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[ElementWrapper](../../get-started/testing/core-classes.md)> | Finds series elements. Use this to assert the number of visible series. | - |
| findTooltip | [CartesianChartTooltipWrapper](https://cloudscape.design/) | Finds chart's tooltip when visible. | - |
| findXAxisTitle | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds visible title of the x axis. | - |
| findYAxisTitle | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds visible title of the y axis. | __0:Optional axis ID to target a specific y axis title (e.g. "secondary"). | BaseChartFilterWrapper 
...
| findRetryButton | [ButtonWrapper](../button/guidelines.md) | Finds no-data retry button when the chart is in error state, and uses the default recovery button. | - | CartesianChartTooltipWrapper 
...
| findPoints | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[PointDetailsItemWrapper](https://cloudscape.design/)> | Finds matched tooltip points. | - | PointDetailsItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDescription | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds tooltip point description when defined. | - |
| findKey | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds tooltip point key. | - |
| findSubItems | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[PointDetailsSubItemWrapper](https://cloudscape.design/)> | Finds point sub-items when defined. | - |
| findValue | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds tooltip point value. | - | PointDetailsSubItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDescription | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds tooltip point description when defined. | - |
| findKey | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds tooltip point key. | - |
| findValue | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds tooltip point value. | - |
## General guidelines
...
- Error bars
- Show the error type in the footer to reduce visual noise, unless you are combining multiple error bar types, then show these near the series and in the footer. See an example for [mixed line and bar with error bars](guidelines.md)  .
...
**Error metrics**  
  ...
  - Metric errors are different for each series: Show the error type and error metric below the series for each error.    
    ...
    - For example: [Error range: 100 - 200](guidelines.md)      .
  - All error metrics are the same for each series: Show the Error type and error metrics in the footer.    

    - For example: [Error range: ±50](guidelines.md)      .

  Use the [error bar series color palette](../../foundation/visual-foundation/data-vis-colors.md)   to ensure error bars are clear and consistent across different chart types.
- #### Responsive sizing
...
- #### Linked series
  ...
  Linked series do not appear as a separate legend items and they inherit colour, visibility, and hover state from the respective primary series. Use this for projected, or supplementary series.
- #### Zoned series

  Zones series allow changing a series' colour and/or dash style at specified x or y thresholds, enabling visual distinction between data segments such as current vs. forecast values. Always use distinct dash styles between zones so the separation is not conveyed by colour alone. Complement zones with an x- or y-threshold marker at the split point to reinforce the boundary.
- #### Dual y-axis
...
[View Documentation](../bar-chart/guidelines.md)
