...
> Source: https://cloudscape.design/components/code-editor/ (fetched 2026-09-24)

With the code editor, users can write and edit code.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/code-editor)
...
The code editor component is an exception to our general [CSP compliance rules](../../get-started/dev-guides/csp.md) . If your web app uses CSP, we recommend using the following configuration:
...
For the full working example, see [the demo below](guidelines.md).
...
The `preferences` property is [controlled](../../get-started/dev-guides/state-management.md) . To handle the preferences for end users, listen to `onPreferencesChange` event and store the preferences received. For example, in a session cookie or a long term cookie.
...
| --- | --- | --- | --- |
| findEditor | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findErrorScreen | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findErrorsTab | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findLoadingScreen | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findNativeTextArea | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLTextAreaElement> &#124; null | - | - |
| findPane | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findSettingsButton | [ButtonWrapper](../button/guidelines.md) &#124; null | - | - |
| findStatusBar | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findWarningsTab | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| setValue | - | Sets the value of the component and calls the onDelayedChange handler | value:The value the input is set to. |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findEditor | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findErrorScreen | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findErrorsTab | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findLoadingScreen | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findNativeTextArea | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findPane | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findSettingsButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findStatusBar | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findWarningsTab | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
## General guidelines

### Do

- Use the [unsaved changes](../../patterns/general/unsaved-changes.md)   pattern to prevent data loss.
...
- Don't use the code editor component to display non-editable code snippets. This component exceeds the functional requirements for read only purposes and is not optimized to support code viewing alone. Use the [code view](../code-view/guidelines.md)   component instead.
...
- #### Errors and warnings summary pane
  ...
  The component does not support localization of error or warning description text. For more information about localization, see the [development guidelines for code editor](guidelines.md)  .
...
- #### Error
  ...
  An error state is displayed when the component fails to load. When the code editor is in an error state, add error state text. Provide a recovery action in the [error state](guidelines.md)   , as a recovery mechanism.
