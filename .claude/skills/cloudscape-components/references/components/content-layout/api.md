...
- **`breadcrumbs?`**: `React.ReactNode`
  Use this slot to add the [breadcrumb group component](../breadcrumb-group/guidelines.md) to the content layout:
  * if your application does not use the [app layout component](../app-layout/guidelines.md), which already offers a `breadcrumbs` slot.
  * If your page uses the [app layout component](../app-layout/guidelines.md) with `disableContentPaddings=true`.
  
  Do not use in conjunction with the `breadcrumbs` slot in the [app layout component](../app-layout/guidelines.md).
...
- **`defaultPadding?`**: `boolean`
  Set it to `true` if your page uses the [app layout component](../app-layout/guidelines.md) with `disableContentPaddings=true`.
...
- **`notifications?`**: `React.ReactNode`
  Use this slot to display [notifications](../flashbar/guidelines.md) to the content layout:
  * If your page does not use the [app layout component](../app-layout/guidelines.md), which already offers a `notifications` slot.
  * If your page uses the [app layout component](../app-layout/guidelines.md) with `disableContentPaddings=true`.
  
  Do not use in conjunction with the `notifications` slot in the [app layout component](../app-layout/guidelines.md).
