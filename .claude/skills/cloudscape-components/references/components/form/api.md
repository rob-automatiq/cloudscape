...
- **`actions?`**: `React.ReactNode`
  Specifies actions for the form. You should wrap action buttons in a [space between component](../space-between/guidelines.md) with `direction="horizontal"` and `size="xs"`.
...
- **`header?`**: `React.ReactNode`
  Specifies the form title and optional description. Use the [header component](../header/guidelines.md).
