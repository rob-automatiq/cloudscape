...
> Source: https://cloudscape.design/components/form/ (fetched 2026-09-24)

A section of a page that has interactive controls with which a user can submit information to a web server.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/form) [View in demo](https://cloudscape.design/examples/react/form.html)
...
Set `contentType="form"` in the [app layout](../app-layout/guidelines.md) component to automatically apply the recommended max content area width and default panel states to the page.

#### Communicating unsaved changes

Ensures users can exit a [single page create](../../patterns/resource-management/create/single-page-create.md) flow at any time.
If a user has entered data in the form and attempts to exit before completing the flow, you must prompt them with a [modal](../modal/guidelines.md) asking them to confirm that they want to exit the flow.
If there is no user input, you may end the creation flow without a prompt. For additional guidelines, see the [communicating unsaved changes](../../patterns/general/unsaved-changes.md) pattern.
...
- Apply the recommended max content area width and default panel states by setting `contentType='form'`   in the [app layout](../app-layout/guidelines.md)   component.
- When used within the app layout, `full-page`   forms must be the first component in the `content`   slot.
- If there are [unsaved changes](../../patterns/general/unsaved-changes.md)   invoke a [modal](../modal/guidelines.md)   when exiting the form.
- Apply standard form [validation](../../patterns/resource-management/create/single-page-create.md)   . Use form field (client-side) and/or page level (server-side) validation depending on your use cases.
- Refer to the [single page create flow](../../patterns/resource-management/create/single-page-create.md)   for additional design guidance on the pattern.

### Don't

- Don't use the "full-page" `variant`   inside of a [content layout](../content-layout/guidelines.md)   component.

## Features

- #### Form header

  Use the h1 variant of the [header](../header/guidelines.md)   component in this area. The form header can include:  

  - A title that clearly and concisely describes the purpose of the form.
  - An info link for page level [help content](../../patterns/general/help-system.md)     (optional).
  - A description detailing the the form's purpose (optional).
- #### Form content

  Form content is organized into sections using [containers](../container/guidelines.md)   . Each container has a [header](../header/guidelines.md)   with a title and an optional description. [Info links](../link/guidelines.md)   may also be included and appended to the container header.
- #### Form actions
...
- #### Variant
  ...
  - **Full page (default)**    
    ...
    - Use this variant if you are following the single-page [create](../../patterns/resource-management/create/single-page-create.md)       or [edit](../../patterns/resource-management/edit/page-edit.md)       patterns.
  - **Embedded**    

    - This variant does not contain a high contrast header.
    - Use this variant if the form is used in another context other than a [create](../../patterns/resource-management/create/single-page-create.md)       or [edit](../../patterns/resource-management/edit/page-edit.md)       page, one that doesn't occupy the full page.
...
- The heading should indicate the main purpose of the form or current step in a [wizard](../wizard/guidelines.md)  .
- Avoid articles (for example: *a, an, the*   ) to keep content short and actionable.
- Include an [Info link](../link/guidelines.md)   as needed.
...
- Follow the guidelines for [button](../button/guidelines.md)  .
