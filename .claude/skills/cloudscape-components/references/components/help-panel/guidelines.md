...
> Source: https://cloudscape.design/components/help-panel/ (fetched 2026-09-24)

The panel displays help content that relates to a concept, term, setting, option, or task within the main page content.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/help-panel)
...
- Place help panel content in the `tools`   slot of the [app layout](../app-layout/guidelines.md)   component. The app layout will provide the dismiss icon and toggle functionality.
...
- For additional guidelines for the behavior of the help panel, see [help system](../../patterns/general/help-system.md)  .
...
- Set the help panel closed by default, except if a [tutorial](../tutorial-panel/guidelines.md)   panel is implemented.
- Persist the user preference for panel open or closed when users navigate across pages that have help content.
- Always use info links to open the help panel. Follow the guidelines for [help system](../../patterns/general/help-system.md)  .
...
- Don't use the help panel for providing step-by-step guidance on how to complete a task, instead use the [hands-on tutorials](../../patterns/general/onboarding/hands-on-tutorials.md)   instead. Follow the guidelines for [onboarding](../../patterns/general/onboarding.md)  .
...
- #### Learn more footer
  ...
  - The header for the *Learn more*     footer should display an external [icon](../icon/guidelines.md)     at the end.
  ...
  Follow the guidelines for [help system](../../patterns/general/help-system.md)  .
- #### App layout

  Place help panel in the `tools`   region of [app layout](../app-layout/guidelines.md)   to get properties such as default panel width and dismiss control functionality.
...
- Follow UX guidelines and writing guidelines for help panel content in [help system.](../../patterns/general/help-system.md)
