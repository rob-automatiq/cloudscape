...
> Source: https://cloudscape.design/components/multiselect/ (fetched 2026-09-24)

Multiselects enable users to choose multiple items from a list of options.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/multiselect)
...
The multiselect component is controlled. Set the `selectedOptions` property and the `onChange` listener to store the selected options in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| findDropdownFooter | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the custom dropdown footer region rendered by renderDropdownFooter, if present. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findDropdownHeader | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the custom dropdown header region rendered by renderDropdownHeader, if present. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
...
| findFilteringInput | [InputWrapper](../input/guidelines.md) &#124; null | Returns the input that is used for filtering. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findInlineLabel | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findInlineToken | [TokenWrapper](../token/guidelines.md) &#124; null | Returns an inline token. | tokenIndex:1-based index of the inline token to return |
| findInlineTokens | Array<[TokenWrapper](../token/guidelines.md)> | - | - |
...
| findToken | [TokenGroupItemWrapper](https://cloudscape.design/) &#124; null | Returns a token. | tokenIndex:1-based index of the token to return |
| findTokens | Array<[TokenGroupItemWrapper](https://cloudscape.design/)> | - | - |
| findTokenToggle | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns a token toggle button. | - |
...
| findSelectedOptions | Array<[OptionWrapper](https://cloudscape.design/)> | - | - | TokenGroupItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDismiss | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findOption | [OptionWrapper](https://cloudscape.design/) | - | - | OptionWrapper 
...
| --- | --- | --- | --- |
| findDropdown | [OptionsDropdownContentWrapper](https://cloudscape.design/) | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findDropdownFooter | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the custom dropdown footer region rendered by renderDropdownFooter, if present. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findDropdownHeader | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the custom dropdown header region rendered by renderDropdownHeader, if present. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
...
| findFilteringInput | [InputWrapper](../input/guidelines.md) | Returns the input that is used for filtering. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findInlineLabel | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findInlineToken | [TokenWrapper](../token/guidelines.md) | Returns an inline token. | tokenIndex:1-based index of the inline token to return |
| findInlineTokens | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[TokenWrapper](../token/guidelines.md)> | - | - |
...
| findToken | [TokenGroupItemWrapper](https://cloudscape.design/) | Returns a token. | tokenIndex:1-based index of the token to return |
| findTokens | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[TokenGroupItemWrapper](https://cloudscape.design/)> | - | - |
| findTokenToggle | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns a token toggle button. | - |
| findTrigger | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - | OptionsDropdownContentWrapper 
...
| findSelectedOptions | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[OptionWrapper](https://cloudscape.design/)> | - | - | TokenGroupItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDismiss | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
...
| findTags | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[ElementWrapper](../../get-started/testing/core-classes.md)> | - | - |
## General guidelines
...
- #### Filtering - optional
  ...
  - Automatic filtering *- *     default    
    ...
    - Use [automatic filtering](guidelines.md)       when the list of options typically takes only one API call to be fetched completely.
  - Manual filtering    

    - Use [manual filtering](guidelines.md)       when the list of options is fetched asynchronously as the user scrolls or types.
...
- #### Additional metadata - optional
  ...
  - Icons are displayed on the left side of the label. View available Cloudscape icons in [iconography](../../foundation/visual-foundation/iconography.md)    .
...
- #### Error
  ...
  - Provide a [recovery action](../select/guidelines.md)     in the error state, as a recovery mechanism.
- #### Finished
