...
> Source: https://cloudscape.design/components/prompt-input/ (fetched 2026-09-24)

Enables users to provide a prompt or command.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/prompt-input)
...
The prompt input component is controlled. Set the `value` or `tokens` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| --- | --- | --- | --- |
| findActionButton | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLButtonElement> | Finds the action button. Note that, despite its typings, this may return null. | - |
| findContentEditableElement | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLDivElement> &#124; null | Finds the contentEditable element used when menus or tokens is defined. | - |
| findCustomPrimaryAction | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLDivElement> &#124; null | - | - |
| findNativeTextarea | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLTextAreaElement> | Finds the native textarea element.Note: When menus or tokens is defined, the component uses a contentEditable element instead of a textarea.In this case, use findContentEditableElement() instead. | - |
| findOpenMenu | [PromptInputMenuWrapper](https://cloudscape.design/) &#124; null | Finds the menu dropdown when menus or tokens is defined. | - |
| findSecondaryActions | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLDivElement> | Finds the secondary actions slot. Note that, despite its typings, this may return null. | - |
| findSecondaryContent | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLDivElement> &#124; null | - | - |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findOption | [OptionWrapper](https://cloudscape.design/) &#124; null | Returns an option from the menu. | optionIndex:1-based index of the option to select. |
| findOptionByValue | [OptionWrapper](https://cloudscape.design/) &#124; null | Returns an option from the menu by its value | value:The 'value' of the option. |
| findOptions | Array<[OptionWrapper](https://cloudscape.design/)> | - | - | OptionWrapper 
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findActionButton | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the action button. Note that, despite its typings, this may return null. | - |
| findContentEditableElement | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the contentEditable element used when menus or tokens is defined. | - |
| findCustomPrimaryAction | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findNativeTextarea | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the native textarea element.Note: When menus or tokens is defined, the component uses a contentEditable element instead of a textarea.In this case, use findContentEditableElement() instead. | - |
| findOpenMenu | [PromptInputMenuWrapper](https://cloudscape.design/) | Finds the menu dropdown when menus or tokens is defined. | - |
| findSecondaryActions | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the secondary actions slot. Note that, despite its typings, this may return null. | - |
| findSecondaryContent | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - | PromptInputMenuWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findOption | [OptionWrapper](https://cloudscape.design/) | Returns an option from the menu. | optionIndex:1-based index of the option to select. |
| findOptionByValue | [OptionWrapper](https://cloudscape.design/) | Returns an option from the menu by its value | value:The 'value' of the option. |
| findOptions | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[OptionWrapper](https://cloudscape.design/)> | - | - | OptionWrapper 
...
- Use prompt input component in the [generative AI chat](../../gen-ai/patterns/generative-ai-chat.md)  .
- To display information regarding [character count](../form-field/guidelines.md)   in the prompt input, use constraint text in the [form field](../form-field/guidelines.md)   component.
- Every prompt input without an action button should have a visible label. Use the [form field](../form-field/guidelines.md)   for labelling your prompt inputs. Prompt inputs with action buttons don't require labels. The action button serves as the label.
...
- Don't use prompt input with an action button as a replacement for [input](../input/guidelines.md)   or [text area](../textarea/guidelines.md)   in a form. This helps users avoid confusion regarding what is being submitted.
...
- #### Action button - optional
  ...
  An action button that allows users to execute the prompt in the input area. For example, a send icon button to let users send their text prompts as described in [generative AI chat](../../gen-ai/patterns/generative-ai-chat.md)  .
- #### Keyboard navigation
...
- #### Secondary actions - optional
  ...
  Additional actions that are related to the prompt input. For example, uploading files, switching response contexts, or conversation settings. Recommended components for this slot are the [button group](../button-group/guidelines.md)   or [icon button](../button/guidelines.md)  .
...
[Page](../../gen-ai/patterns/shortcut-menus.md)
...
- Follow the writing guidelines for [placeholder text](../../gen-ai/patterns/generative-ai-chat.md)   on generative AI chat pattern.

#### Constraint text

- Follow the writing guidelines for [constraint text](../form-field/guidelines.md)  .
...
- Follow writing guidelines for [button](../button/guidelines.md)  .
...
- The placeholder disappears when the user has typed in the input area. For important information that you want to persist on the page, use [constraint text](../form-field/guidelines.md)   instead.
