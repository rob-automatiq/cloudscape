...
> Source: https://cloudscape.design/components/property-filter/ (fetched 2026-09-24)
...
With the property filter, users can find specific items in a collection by using properties, property values, typing free text, and combining these with operators.
 ...
 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/property-filter) [View property filter demo](https://cloudscape.design/examples/react/table-property-filter.html) [View server-side property filter demo](https://cloudscape.design/examples/react/server-side-table-property-filter.html) [View property filter with dates demo](https://cloudscape.design/examples/react/table-date-filter.html) [View saved filter sets demo](https://cloudscape.design/examples/react/table-saved-filters.html)
...
The property filter component is controlled. Set the `query` property and the `onChange` listener to store its value in the state of your application. Refer to [state management guidelines](../../get-started/dev-guides/state-management.md) for components.
...
| findConstraint | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the element containing the filteringConstraintText slot. | - |
| findCustomControl | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the element containing the customControl slot. | - |
| findCustomFilterActions | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the element containing the customFilterActions slot. | - |
| findDropdown | [AutosuggestDropdownWrapper](https://cloudscape.design/) | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findEnteredTextOption | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findErrorRecoveryButton | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
...
| findPropertyCancelButton | [ButtonWrapper](../button/guidelines.md) &#124; null | Returns custom property form cancel button. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findPropertySubmitButton | [ButtonWrapper](../button/guidelines.md) &#124; null | Returns custom property form submit button. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findRemoveAllButton | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the button that removes all current tokens. | - |
| findResultsCount | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findStatusIndicator | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findSuffix | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findTokens | Array<[FilteringTokenWrapper](https://cloudscape.design/)> | - | - |
| findTokenToggle | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the button that toggles if the tokens above tokenLimit are visible. | - |
| focus | - | - | - |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDisabledOptions | Array<[OptionWrapper](https://cloudscape.design/)> | Returns all the selected options. | - |
...
| findOptionByValue | [OptionWrapper](https://cloudscape.design/) &#124; null | Returns an option from the autosuggest by it's value | value:The 'value' of the option. |
...
| findOptionsContainer | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Use this element to scroll through the list of options | - | FilteringTokenWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findEditButton | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLButtonElement> | - | - |
| findEditorDropdown | [PropertyFilterEditorDropdownWrapper](https://cloudscape.design/) &#124; null | Returns dropdown content of editing token if opened or null otherwise. | options: |
| findGroupTokens | Array<[FilteringGroupedTokenWrapper](https://cloudscape.design/)> | - | - |
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findRemoveButton | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLButtonElement> | - | - |
| findTokenOperation | [SelectWrapper](../select/guidelines.md) &#124; null | - | - | OptionWrapper 
...
| findForm | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findHeader | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findOperatorField | [FormFieldWrapper](../form-field/guidelines.md) | - | index: |
| findPropertyField | [FormFieldWrapper](../form-field/guidelines.md) | - | index: |
| findSubmitButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findTokenAddActions | [ButtonDropdownWrapper](../button-dropdown/guidelines.md) &#124; null | - | - |
| findTokenRemoveActions | [ButtonDropdownWrapper](../button-dropdown/guidelines.md) &#124; null | - | index: |
| findValueField | [FormFieldWrapper](../form-field/guidelines.md) | - | index: | FilteringGroupedTokenWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findRemoveButton | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLButtonElement> | - | - |
| findTokenOperation | [SelectWrapper](../select/guidelines.md) &#124; null | - | - |
...
| findConstraint | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the element containing the filteringConstraintText slot. | - |
| findCustomControl | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the element containing the customControl slot. | - |
| findCustomFilterActions | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the element containing the customFilterActions slot. | - |
| findDropdown | [AutosuggestDropdownWrapper](https://cloudscape.design/) | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findEnteredTextOption | [ElementWrapper](../../get-started/testing/core-classes.md) | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findErrorRecoveryButton | [ElementWrapper](../../get-started/testing/core-classes.md) | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
...
| findPropertyCancelButton | [ButtonWrapper](../button/guidelines.md) | Returns custom property form cancel button. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findPropertySubmitButton | [ButtonWrapper](../button/guidelines.md) | Returns custom property form submit button. | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findRemoveAllButton | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the button that removes all current tokens. | - |
| findResultsCount | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findStatusIndicator | [ElementWrapper](../../get-started/testing/core-classes.md) | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findSuffix | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findTokens | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[FilteringTokenWrapper](https://cloudscape.design/)> | - | - |
| findTokenToggle | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the button that toggles if the tokens above tokenLimit are visible. | - | AutosuggestDropdownWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDisabledOptions | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[OptionWrapper](https://cloudscape.design/)> | Returns all the selected options. | - |
...
| findOptionByValue | [OptionWrapper](https://cloudscape.design/) | Returns an option from the autosuggest by it's value | value:The 'value' of the option. |
...
| findOptionsContainer | [ElementWrapper](../../get-started/testing/core-classes.md) | Use this element to scroll through the list of options | - | FilteringTokenWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findEditButton | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findEditorDropdown | [PropertyFilterEditorDropdownWrapper](https://cloudscape.design/) &#124; null | Returns dropdown content of editing token if opened or null otherwise. | options: |
| findGroupTokens | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[FilteringGroupedTokenWrapper](https://cloudscape.design/)> | - | - |
...
| findTokenOperation | [SelectWrapper](../select/guidelines.md) | - | - | OptionWrapper 
...
| findTags | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[ElementWrapper](../../get-started/testing/core-classes.md)> | - | - | PropertyFilterEditorDropdownWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findCancelButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findDismissButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findForm | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
...
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findRemoveButton | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findTokenOperation | [SelectWrapper](../select/guidelines.md) | - | - |
## General guidelines
...
- Use a property filter pattern if users need more than two properties to find a specific item. If only two are required, use the [collection select filter](../collection-select-filter/guidelines.md)   instead.
...
- #### Properties
  ...
  A list of properties of the data set is displayed when the user triggers the search input field. Usually, properties refer to the column headers for a [table view](../../patterns/resource-management/view/table-view.md)   , and content labels for a [cards view](../../patterns/resource-management/view/card-view.md)  .
- #### Values

  The corresponding list of finite values is displayed when the user chooses one of the properties and an operator. Usually, values refer to the content of table cells in the [table view](../../patterns/resource-management/view/table-view.md)   , and card contents in the [cards view](../../patterns/resource-management/view/card-view.md)  .
...
- #### Search input states
  ...
  The property filter uses the [autosuggest](../autosuggest/guidelines.md)   for the search input. Refer to the [autosuggest usage guidance](../autosuggest/guidelines.md)   for more information on property filter input states, such as error, loading, async loading.

### Tokens

Property filter uses [tokens](../token/guidelines.md) to represent each filter facet that is filtering the collection.
...
- #### Filtering tokens
  ...
  Tokens default to containing a single value per property, but can also be multi-select. **Multi-select tokens**   allow users to select multiple values when filtering by that property. See [development guidelines](guidelines.md)   for how to implement this feature.
...
- #### Token editing
  ...
  Once a token has been added, it can be edited by clicking on the token text. This opens a [popover](../popover/guidelines.md)   , where the property, operator, and value can be changed.
...
- #### Custom control - optional
  ...
  - For example, showing a [select](../select/guidelines.md)     for quick access to saved filter sets in the [saved filter sets](../../patterns/general/filter-patterns/saved-filter-sets.md)     pattern.
- #### Custom filter actions - optional
  ...
  - For example, showing a [button dropdown](../button-dropdown/guidelines.md)     with main action to display additional filter actions for the [saved filter sets](../../patterns/general/filter-patterns/saved-filter-sets.md)     pattern.
...
- #### Loading state
  ...
  The state of the collection of items, either [table](../table/guidelines.md)   or [cards](../cards/guidelines.md)   , while the filtered dataset is being loaded. Follow the guidelines for [loading state](../../patterns/general/loading-and-refreshing.md)   for collections.
- #### Zero results state

  The state of the collection of items, either [table](../table/guidelines.md)   or [cards](../cards/guidelines.md)   , after a user applies a filter that does not return any items in the collection. Follow the guidelines for [empty states](../../patterns/general/empty-states.md)  .
...
- Follow the writing guidelines for [text filter](../text-filter/guidelines.md)  .

#### Loading state

- Follow the writing guidelines for [loading state](../../patterns/general/loading-and-refreshing.md)  .
