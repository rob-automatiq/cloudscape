...
> Source: https://cloudscape.design/components/select/ (fetched 2026-09-24)

Selects enable users to choose a single item from a list of items.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/select)
...
The select component is controlled. Set the `selectedOption` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| findSelectedOptions | Array<[OptionWrapper](https://cloudscape.design/)> | - | - | OptionWrapper 
...
| findSelectedOptions | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[OptionWrapper](https://cloudscape.design/)> | - | - | OptionWrapper 
...
- Always include a visible label. In forms, use the [form field](../form-field/guidelines.md)   . In filtering use cases such as the [collection select filter](../collection-select-filter/guidelines.md)   , or when vertical space is limited, use an inline label.

### Don't

- Don't use select when users need to initiate an action from a large set of actions. Use [button dropdown with filtering enabled](../button-dropdown/guidelines.md)   instead.
...
**Form field label**  
  When used in forms, wrap the select in a [form field](../form-field/guidelines.md)   . This provides a label above the input along with a description and validation. For example, when setting permissions, a select dropdown allows users to choose role or policy.  
...
**Inline label**  
  ...
  Follow the guidelines for the [collection select filter](../collection-select-filter/guidelines.md)  .
...
- #### Filtering - optional
  ...
  - Automatic filtering *- *     default    
    ...
    - Use [automatic filtering](guidelines.md)       when the list of options usually takes only one API call to be fetched completely.
  - Manual filtering    
...
- #### Additional metadata - optional
  ...
  - Icons are displayed on the left side of the label. View available icons in our [iconography](../../foundation/visual-foundation/iconography.md)     article.
...
- #### Error
  ...
  - Provide a [recovery action](guidelines.md)     in the error state, as a recovery mechanism.
- #### Finished
...
- Names of inputs are a short description of the corresponding control, follow the guidelines for [form field labels](../form-field/guidelines.md)  .
...
- Error message  
  ...
  - Follow the guidelines for [validation](../../patterns/general/errors/validation.md)     and [alerts and error messages](../alert/guidelines.md)    .
- Recovery action  
