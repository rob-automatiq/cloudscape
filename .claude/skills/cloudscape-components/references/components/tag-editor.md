...
Generated from `@cloudscape-design/components@3.0.1382` `tag-editor/interfaces.d.ts`. Descriptions are the library's own JSDoc (the same text as the API tab on cloudscape.design).
...
- **`i18nStrings?`**: `TagEditorProps.I18nStrings` _(@i18n)_
...
Supporting types from `TagEditorProps` (verbatim):
