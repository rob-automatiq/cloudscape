...
> Source: https://cloudscape.design/components/textarea/ (fetched 2026-09-24)

A form element that provides a multi-line, plain-text input control.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/textarea)
...
The textarea component is controlled. Set the `value` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| --- | --- | --- | --- |
| findNativeTextarea | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLTextAreaElement> | - | - |
