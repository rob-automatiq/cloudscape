...
> Source: https://cloudscape.design/components/tree-view/ (fetched 2026-09-24)

A hierarchical list of nested items.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/tree-view)
...
| --- | --- | --- | --- |
| findItemById | [TreeViewItemWrapper](https://cloudscape.design/) &#124; null | Finds a visible tree view item by its ID. | id:of the item to findoptions:* expanded (optiona, boolean) - Use it to find the visible expanded or collapsed item. |
| findItems | Array<[TreeViewItemWrapper](https://cloudscape.design/)> | Finds all visible tree view items. | options:* expanded (optional, boolean) - Use it to find all visible expanded or collapsed items. | TreeViewItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findActions | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds the actions slot of the tree view item. | - |
| findChildItemById | [TreeViewItemWrapper](https://cloudscape.design/) &#124; null | Finds a visible child item by its ID. | id:of the item to findoptions:* expanded (optional, boolean) - Use it to find the visible expanded or collapsed child item. |
| findChildItems | Array<[TreeViewItemWrapper](https://cloudscape.design/)> | Finds all visible child items of the tree view item. | options:* expanded (optional, boolean) - Use it to find all visible expanded or collapsed child items. |
| findContent | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds the content slot of the tree view item. | - |
| findIcon | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds the icon slot of the tree view item. | - |
| findItemToggle | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds the expand toggle of the tree view item. | - |
| findSecondaryContent | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Finds the secondary content slot of the tree view item. | - |
...
| --- | --- | --- | --- |
| findItemById | [TreeViewItemWrapper](https://cloudscape.design/) &#124; null | Finds a visible tree view item by its ID. | id:of the item to findoptions:* expanded (optiona, boolean) - Use it to find the visible expanded or collapsed item. |
| findItems | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[TreeViewItemWrapper](https://cloudscape.design/)> | Finds all visible tree view items. | options:* expanded (optional, boolean) - Use it to find all visible expanded or collapsed items. | TreeViewItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findActions | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the actions slot of the tree view item. | - |
| findChildItemById | [TreeViewItemWrapper](https://cloudscape.design/) &#124; null | Finds a visible child item by its ID. | id:of the item to findoptions:* expanded (optional, boolean) - Use it to find the visible expanded or collapsed child item. |
| findChildItems | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[TreeViewItemWrapper](https://cloudscape.design/)> | Finds all visible child items of the tree view item. | options:* expanded (optional, boolean) - Use it to find all visible expanded or collapsed child items. |
| findContent | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the content slot of the tree view item. | - |
| findIcon | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the icon slot of the tree view item. | - |
| findItemToggle | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the expand toggle of the tree view item. | - |
| findSecondaryContent | [ElementWrapper](../../get-started/testing/core-classes.md) | Finds the secondary content slot of the tree view item. | - |
## General guidelines

### Do

- Use inline [icon](../button/guidelines.md)   , [link](../button/guidelines.md)   buttons, and [inline icon button dropdown](../button-dropdown/guidelines.md)   to display contextual actions to complement the paddings in a tree item.
...
- Don't use a tree view for non-hierarchical display of items, use a [list](../list/guidelines.md)   instead.
- Don't use a tree view for a flat list of steps without hierarchical sub-steps, use the [steps](../steps/guidelines.md)   component instead.
- Don't use a tree view to show or hide information for a standalone item. Use an [expandable section](../expandable-section/guidelines.md)   instead.
- Don't use a tree view to show tabular information with nesting. Use a [table with expandable rows](../table/guidelines.md)   instead.
...
- #### Keyboard navigation
  ...
  Only use the following interactive elements in tree view items: [button](../button/guidelines.md)   , [button dropdown](../button-dropdown/guidelines.md)   , [toggle button](../toggle-button/guidelines.md)   , [link](../link/guidelines.md)   , [popover](../popover/guidelines.md)  .
- #### Content

  The content that identifies a tree item, such as a label, to ensure proper context for users. The content can include [text](../text-content/guidelines.md)   , [link](../link/guidelines.md)   , and [status indicator](../status-indicator/guidelines.md)   . For example, a link to the resource name.
- #### Icon - optional
...
- #### Secondary content - optional
  ...
  Wrap secondary content with a [box](../box/guidelines.md)   and use small font and text-body-secondary color. If there is an icon, ensure the small size is used.
- #### Actions - optional

  Actions related to an individual item. Display inline [icon](../button/guidelines.md)   or [link](../button/guidelines.md)   buttons for individual actions, and [inline icon button dropdown](../button-dropdown/guidelines.md)   for list of related actions. Refer to [in-context actions](../../patterns/general/actions/incontext-actions.md)   for more guidelines.
