...
> Source: https://cloudscape.design/components/wizard/ (fetched 2026-09-24)
...
A multi-page form that guides a user through a complex flow or a series of interrelated tasks. A wizard consists of a navigation pane, header, main content area, and action buttons.
 ...
 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/wizard) [View in demo](https://cloudscape.design/examples/react/wizard.html)
...
Set `contentType="wizard"` in the [app layout](../app-layout/guidelines.md) component to automatically apply the recommended max content area width and default panel states to the page.
...
Ensure users can exit a [multipage create](../../patterns/resource-management/create/multi-page-create.md) flow at any time. If a user has entered data in the form and attempts to exit before completing the flow, you must prompt them with a [modal](../modal/guidelines.md) asking them to confirm that they want to exit the flow. If there is no user input, you may end the creation flow without a prompt. For additional guidelines, see the [communicating unsaved changes](../../patterns/general/unsaved-changes.md) pattern.
...
If you want to control which step is active, you need to explicitly set the `activeStepIndex` property and provide an `onNavigate` listener. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| findError | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
...
| findMenuNavigationLink | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns a link for a given step number. | stepNumber:1-based step indexstate:[optional] State of the link. The method returns null if the specified step does not match the state. It can be - "disabled": for disabled menu entries - "active": for the active menu entry - undefined: for any entry |
| findMenuNavigationLinks | Array<[ElementWrapper](https://cloudscape.design/)> | - | - |
| findPreviousButton | [ButtonWrapper](../button/guidelines.md) &#124; null | - | - |
| findPrimaryButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findSecondaryActions | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findSkipToButton | [ButtonWrapper](../button/guidelines.md) &#124; null | - | - |
...
| findError | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findHeader | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findInfo | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findMenuNavigationLink | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns a link for a given step number. | stepNumber:1-based step indexstate:[optional] State of the link. The method returns null if the specified step does not match the state. It can be - "disabled": for disabled menu entries - "active": for the active menu entry - undefined: for any entry |
| findMenuNavigationLinks | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[ElementWrapper](../../get-started/testing/core-classes.md)> | - | - |
| findPreviousButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findPrimaryButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findSecondaryActions | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findSkipToButton | [ButtonWrapper](../button/guidelines.md) | - | - |
## General guidelines

### Do

- Apply the recommended max content area width and default panel states  by setting `contentType='wizard'`   in the [app layout](../app-layout/guidelines.md)   component.
- When used within the app layout, the wizard must be the first component in the `content`   slot.
- Trigger a [modal](../modal/guidelines.md)   upon  exiting the wizard if there are [unsaved changes](../../patterns/general/unsaved-changes.md)   in  the flow.
...
- Apply standard form [validation](../../patterns/resource-management/create/multi-page-create.md)   ; use form field (client-side) or page-level (server-side)  validation depending on your use cases.
- Display the choices on the review page in the same order they were  presented in the previous steps.
- Refer to the [multipage create](../../patterns/resource-management/create/multi-page-create.md)   pattern for additional design guidance.
...
- Don't use the wizard inside of a [content layout](../content-layout/guidelines.md)   component.

## Features

### Navigation pane

The navigation pane is the numbered list of steps that serve as navigation, as well as an overall outline of the user's progress through a [multipage create](../../patterns/resource-management/create/multi-page-create.md) pattern.
...
- #### Form header
  ...
  - Info link: If you are using the [help panel](../help-panel/guidelines.md)     , add an info link for page level [help content](../../patterns/general/help-system.md)    .
...
- #### Form content
  ...
  The main content area of the page where the [form containers](../container/guidelines.md)   , [form fields](../form-field/guidelines.md)   , and form controls such as [inputs](../input/guidelines.md)   and [radio buttons](../radio-group/guidelines.md)   , are displayed.  

  We recommend you make the last page of the wizard a review page that summarizes the choices made in previous steps.  A review page ensures users can review their information and quickly go back to any step for edits. Follow the guidelines for [multipage create](../../patterns/resource-management/create/multi-page-create.md)   pattern and see the [demo page](https://cloudscape.design/examples/react/wizard.html)   for examples.
- #### Validation error message (server side) - optional

  Text that is rendered inside a page-level [alert](../alert/guidelines.md)   above the form's action buttons. This should be used for overall form submission errors such as recoverable, server-side validation failures.
- #### Form action buttons
  ...
  - **Cancel**    
    ...
    - Ensures a user can exit the flow. A user should be able to exit the flow at any time. If a user has [unsaved changes](../../patterns/general/unsaved-changes.md)       in the form and attempts to exit before completing the flow, you must prompt them with a modal asking them to confirm that they want to exit the flow. If there is no user input, you may terminate the wizard without a prompt.
  - **Previous**    
...
[View Documentation](../form/guidelines.md)
...
- Follow the writing guidelines for [form](../form/guidelines.md)  .
...
- Follow the guidelines for [validation](../../patterns/general/errors/validation.md)  .
...
- Follow the writing guidelines for [button](../button/guidelines.md)   and [form](../form/guidelines.md)  .
...
- Follow the accessibility guidelines for [forms](../form/guidelines.md)  .
