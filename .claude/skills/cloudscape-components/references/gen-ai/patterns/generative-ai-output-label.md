...
> Source: https://cloudscape.design/gen-ai/patterns/generative-ai-output-label/ (fetched 2026-09-24)
...
Refer to code example below to build the generative AI output label using the [box](../../components/box/guidelines.md) and [icon](../../components/icon/guidelines.md) components.
