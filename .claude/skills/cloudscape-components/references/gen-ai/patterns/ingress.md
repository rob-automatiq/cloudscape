...
> Source: https://cloudscape.design/gen-ai/patterns/ingress/ (fetched 2026-09-24)
...
Refer to the code examples below for the primary and secondary [buttons](../../components/button/guidelines.md) when used in the context of generative AI.
...
const Icons = () => {
  return <Button iconName="edit-gen-ai">Normal button</Button>;
};
...
const Icons = () => {
  return <Button iconName="search-gen-ai" variant="icon" />;
};
