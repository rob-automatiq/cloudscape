...
> Source: https://cloudscape.design/get-started/for-developers/internationalization/ (fetched 2026-09-24)
...
The following locales are included: `en` , `en-GB` , `de` , `es` , `fr` , `ja` , `it` , `pt-BR` , `ko` , `zh-CN` , `zh-TW` , `id` , `tr`.
