...
> Source: https://cloudscape.design/get-started/for-developers/using-cloudscape-components/ (fetched 2026-09-24)
...
You can find a full list of components with accompanying documentation on the [components page](../../components/index.md). We use TypeScript definitions to document component properties. If you're using a TypeScript-aware editor, such as [VS Code](https://code.visualstudio.com/) , you can see the full list of components, their available properties, and property types and accepted values with autocomplete or IntelliSense.

### Step 5: Integrate with testing libraries

You can configure Cloudscape components to use them alongside testing libraries, such as [Jest](https://jestjs.io/) . For more information, see [testing frameworks integration](../testing/frameworks.md).

## Available packages

### @cloudscape-design/components

This is the main Cloudscape package. It contains the React [components](../../components/index.md) , including the TypeScript definitions.

### @cloudscape-design/board-components

This Cloudscape package contains the React components for [configurable dashboard pattern](../../patterns/general/service-dashboard/configurable-dashboard.md) , including the TypeScript definitions.

### @cloudscape-design/chat-components

This Cloudscape package contains the React components for [generative AI patterns](../../gen-ai/patterns/generative-ai-loading-states.md) , including the TypeScript definitions.

### @cloudscape-design/chart-components

This Cloudscape package contains the React components for [data visualisation](../../patterns/general/data-vis.md).

### @cloudscape-design/code-view

This Cloudscape package contains the React component and languages rules for syntax highlighting for [code view](../../components/code-view/guidelines.md) , including the TypeScript definitions.

### @cloudscape-design/global-styles

The [global styles](global-styles.md) package contains site-level, typography-related styles, including the Open Sans font. To ensure consistent styling, import it once into every Cloudscape application.

### @cloudscape-design/collection-hooks

 [Collection hooks](../dev-guides/collection-hooks.md) are React hooks that you can use to control the state of the [table](../../components/table/guidelines.md) and [cards](../../components/cards/guidelines.md) components, in addition to related components, such as [textfilter](../../components/text-filter/guidelines.md) and [pagination](../../components/pagination/guidelines.md).

### @cloudscape-design/design-tokens

With this package, you'll get a set of [design tokens](../../foundation/visual-foundation/design-tokens.md) in a variety of formats. You can use these tokens to build custom components that are visually consistent with Cloudscape.

### @cloudscape-design/components/test-utils

This internal package is used to create utilities for writing unit and integration tests. For more information, see [introduction to testing](../testing/introduction.md).
...
For example, you can add a link to an [alert](../../components/alert/guidelines.md) header:
...
Some components emit custom events, for example when a [button](../../components/button/guidelines.md) is pressed. The API documentation for each component displays the full list of events emitted by a component.
