...
> Source: https://cloudscape.design/patterns/general/actions/ (fetched 2026-09-24)
...
[View Documentation](actions/global-actions.md)
...
- **Global actions: **   Place in the page header, or as part of the full page [table](../../components/table/guidelines.md)   or [cards](../../components/cards/guidelines.md)   header. For example: A primary action in the table header to create a new resource.
