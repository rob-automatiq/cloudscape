...
> Source: https://cloudscape.design/patterns/general/image-magnifier/ (fetched 2026-09-24)
...
- Always include both dismiss and close buttons in a [modal](../../components/modal/guidelines.md)  .

### Don't

- Don't use image magnifier for simple images, such as icons or illustrations.
- Don't stretch or distort the image when displaying it in the [modal](../../components/modal/guidelines.md)  .
...
- Follow the guidelines for [modal](../../components/modal/guidelines.md)  .

#### Button

- For the dismiss button, use this text: *Close*
- Follow the guidelines for [button](../../components/button/guidelines.md)  .
