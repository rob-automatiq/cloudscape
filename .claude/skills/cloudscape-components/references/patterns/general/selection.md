...
> Source: https://cloudscape.design/patterns/general/selection/ (fetched 2026-09-24)
...
[View Documentation](../../components/toggle/guidelines.md)

### Radio group

Radio group enable users to choose one option from a predefined set.

[View Documentation](../../components/radio-group/guidelines.md)

### Select

Selects enable users to choose a single item from a list of items.

[View Documentation](../../components/select/guidelines.md)

### Checkbox

Checkboxes enable users to turn an option on or off.

[View Documentation](../../components/checkbox/guidelines.md)
...
[View Documentation](../../components/tiles/guidelines.md)

### Multiselect

Multiselects enable users to choose multiple items from a list of options.

[View Documentation](../../components/multiselect/guidelines.md)

### Autosuggest

Autosuggest enables users to choose from a list of suggestions.

[View Documentation](../../components/autosuggest/guidelines.md)
...
The fastest way for users to ﬁnd and select an option in a list of seven or fewer options is to see all the options at once as a group of [checkboxes](../../components/checkbox/guidelines.md) , [radio buttons](../../components/radio-group/guidelines.md) , or [tiles](../../components/tiles/guidelines.md) . For groups of eight or more options, we recommend using a select or autosuggest list. This will reduce the space the selection pattern takes on the page and help the user find options within larger groups.
...
The fastest way for users to ﬁnd and select an option in a list of seven or fewer options is to see all the options at once as a group of [checkboxes](../../components/checkbox/guidelines.md) . For groups of eight or more options, we recommend using a [multiselect](../../components/multiselect/guidelines.md) list. This will reduce the space the selection pattern takes on the page and to help the user find options within larger groups.
...
- When using toggles or checkboxes in multiple places in a page to turn groups of elements on and off, use the same parent control, [toggle](../../components/toggle/guidelines.md)   , or [checkbox](../../components/checkbox/guidelines.md)   throughout.
...
- In progressive disclosure patterns, don't include controls in between radio options. Place them after the [radio group](../../components/radio-group/guidelines.md)  .
