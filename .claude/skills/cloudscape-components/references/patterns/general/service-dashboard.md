...
> Source: https://cloudscape.design/patterns/general/service-dashboard/ (fetched 2026-09-24)
...
[View Documentation](service-dashboard/static-dashboard.md)
...
[View Documentation](service-dashboard/dashboard-items.md)
...
When building a dashboard you can decide the level of control you want to provide to your users. We provide the option to make [dashboard configurable](service-dashboard/configurable-dashboard.md) by your users, which includes the possibility to add, remove, and arrange [dashboard items](service-dashboard/dashboard-items.md) based on their preferences.

### Where dashboards fit in services

The dashboard page may be used as the default landing page of a service for returning users. Make sure to reflect it in your service [side navigation](../../components/side-navigation/guidelines.md) , by placing the dashboard as first link listed in it.
