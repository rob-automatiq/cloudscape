...
> Source: https://cloudscape.design/patterns/resource-management/create/sub-resource-create/ (fetched 2026-09-24)
...
Leverage the [communicating unsaved changes](../../general/unsaved-changes.md) pattern to safeguard users from accidental data loss. This ensures users are informed before discarding changes. For example:
...
Group of [radios](../../../components/radio-group/guidelines.md) or [tiles](../../../components/tiles/guidelines.md) that when selected show:
...
A [select](../../../components/select/guidelines.md) with a list of the available resources.
...
Use a [normal icon button](../../../components/button/guidelines.md) to allow for refreshing of the select to show the newly created resource.
...
Use a [normal button](../../../components/button/guidelines.md) to submit the form.
...
2. Display a error flashbar for immutable errors returned from the API after a submission. Refer to [validation](../../general/errors/validation.md) [error message](../../general/errors/error-messages.md)  .

## With Validation

1. Validate inputs for recoverable errors upon form submission. Refer to the [validation guidelines](../../general/errors/validation.md)  .
...
- Use [page level validation](../../general/errors/validation.md)   . For example, show a success flashbar when a resource is created.
- Provide [field validation](../../general/errors/validation.md)   within the split panel when a user fills in or submits the form.
- Use a [normal button](../../../components/button/guidelines.md)   to trigger the side panel, or a link button with external icon when taking the user to a new tab.
...
- Communicate [unsaved changes](../../general/unsaved-changes.md)   when canceling or submitting a parent flow if there is a sub-create processing, and when closing the split panel when the user has entered content.
...
Follow the writing guidelines for [buttons](../../../components/button/guidelines.md).
Follow the writing guidelines for [validation.](../../general/errors/validation.md)
