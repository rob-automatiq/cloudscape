...
> Source: https://cloudscape.design/patterns/resource-management/delete/delete-with-simple-confirmation/ (fetched 2026-09-24)

Provide a layer of confirmation before deleting resources that cannot be easily recreated.

 [View demo](https://cloudscape.design/examples/react/delete-with-simple-confirmation.html)
## Building blocks
...
- Don't use the delete with simple confirmation pattern if deleting the resource poses a risk of breaking other infrastructure, or causing an outage. Use [delete with additional confirmation](delete-with-additional-confirmation.md)   instead.
...
[View Documentation](delete-with-additional-confirmation.md)
