...
> Source: https://cloudscape.design/patterns/resource-management/delete/one-click-delete/ (fetched 2026-09-24)

With the one-click delete pattern, users can quickly delete low-risk, non-critical resources.

 [View demo](https://cloudscape.design/examples/react/delete-one-click.html?awsui-visual-refresh=true)
## Key UX concepts

With one-click delete, users can quickly delete non-critical, easy to recreate resources. For example, the deletion of a row in [attribute editor](../../../components/attribute-editor/guidelines.md) . Deletion is instantaneous and doesn't require additional feedback.
...
Allow users to delete the element by adding a Remove** ** [button](../../../components/button/guidelines.md).

#### B. Undo - optional

Allow users revoke the last performed deletion by adding an Undo [link](../../../components/link/guidelines.md).
