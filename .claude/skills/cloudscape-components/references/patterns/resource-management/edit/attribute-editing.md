...
> Source: https://cloudscape.design/patterns/resource-management/edit/attribute-editing/ (fetched 2026-09-24)
...
When editing rows of attributes, use the [attribute editor](../../../components/attribute-editor/guidelines.md) component.
...
Use a [button dropdown with main action](../../../components/button-dropdown/guidelines.md) when additional actions are needed, or use the [icon button dropdown](../../../components/button-dropdown/guidelines.md) for in-context actions when reducing visual noise and optimizing content density is a priority.

## Building blocks - advanced attribute editing

Advanced attribute editing is achieved using a combination of [expandable sections](../../../components/expandable-section/guidelines.md) and a series of [form fields](../../../components/form-field/guidelines.md).

A B C D E
#### A. Expandable section

Use the [stacked variant](../../../components/expandable-section/guidelines.md) of the expandable section. The label of this section should align with its container's heading, and similarly, should be a noun describing its content, not an action.
...
Users can remove sections with the *Remove* button. Use the [delete with simple confirmation](../delete/delete-with-simple-confirmation.md) pattern to prevent accidental deletion of configured attributes.

#### E. Section actions - optional

Use a [button dropdown with main action](../../../components/button-dropdown/guidelines.md) when additional actions are needed

## Other features

### Nested attribute editing

When an [attribute editor](../../../components/attribute-editor/guidelines.md) component is used inside of an advanced attribute editor section, use the [icon button dropdown](../../../components/button-dropdown/guidelines.md) for row actions and the [inline link button](../../../components/button/guidelines.md) for adding rows to visually reinforce the appropriate hierarchy.
...
- Use the [delete with simple confirmation](../delete/delete-with-simple-confirmation.md)   pattern for removing advanced attribute editor sections.
- Use [field validation](../../general/errors/validation.md)   for both simple and advanced attribute editing.
...
**Labels**
Follow the writing guidelines for [form field label](../../../components/form-field/guidelines.md).
...
**Autosuggest**
Follow the writing guidelines for [autosuggest](../../../components/autosuggest/guidelines.md).

**Select**
Follow the writing guidelines for [select](../../../components/select/guidelines.md).

**Empty state**
Follow the writing guidelines for [empty states](../../general/empty-states.md).
...
- Follow the guidelines for the [attribute editor](../../../components/attribute-editor/guidelines.md)   component.
