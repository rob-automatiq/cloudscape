...
> Source: https://cloudscape.design/patterns/resource-management/view/ (fetched 2026-09-24)
...
[View Documentation](view/table-view.md)
...
[View Documentation](view/card-view.md)
...
[View Documentation](view/split-view.md)
...
Split view is an *optional* extension of the [table view](view/table-view.md) or [card view](view/card-view.md) that adds a collapsible panel for displaying additional resource details. It is effective when users need to quickly view or compare resource details of multiple resources in-context to resource collection. Use a split view only when your users go through workflows such as monitoring or troubleshooting, which often require an additional layer of details on the table/card view. Don't use a split view when standard table/card view with separate [details page](details.md) meets your user's need.
