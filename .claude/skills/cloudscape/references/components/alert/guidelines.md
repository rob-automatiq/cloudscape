...
> Source: https://cloudscape.design/components/alert/ (fetched 2026-09-24)

A brief message that provides information or instructs users to take a specific action.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/alert)
...
The alert component is controlled. If the alert is dismissible, use `onDismiss` listener to hide it. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| findActionSlot | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
...
| findRootElement | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | Returns the container node of the component. | - |
...
| findActionSlot | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
...
| findRootElement | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the container node of the component. | - |
## General guidelines
...
- Avoid adding links to the header. If you need to link out to more information, use the content area.
...
- #### Content
  ...
  Use the content area to provide details about the alert. If more information about the topic is needed, use `primary` variant of inline [normal links](../link/guidelines.md)   or Learn more [external links](../link/guidelines.md)   to relevant documentation.  
...
- #### Error
  ...
  Use for [errors messages](../../patterns/general/errors/error-messages.md)   , malfunctions, unsuccessful actions, and critical issues.
- #### Warning
