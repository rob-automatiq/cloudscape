...
> Source: https://cloudscape.design/components/anchor-navigation/ (fetched 2026-09-24)

Allows users to quickly jump to specific page content via predefined anchor links.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/anchor-navigation) [Product details demo](https://cloudscape.design/examples/react/product-detail-page.html)
...
| --- | --- | --- | --- |
| findActiveAnchor | [AnchorItemWrapper](https://cloudscape.design/) &#124; null | - | - |
| findAnchorByIndex | [AnchorItemWrapper](https://cloudscape.design/) &#124; null | - | index: |
| findAnchorLinkByHref | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLAnchorElement> &#124; null | - | href: |
| findAnchorNavigation | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLOListElement> &#124; null | - | - |
| findAnchorNavigationList | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLOListElement> &#124; null | - | - |
| findAnchors | Array<[AnchorItemWrapper](https://cloudscape.design/)> | - | - | AnchorItemWrapper 
...
| findText | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| isActive | boolean | - | - |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findActiveAnchor | [AnchorItemWrapper](https://cloudscape.design/) | - | - |
| findAnchorByIndex | [AnchorItemWrapper](https://cloudscape.design/) | - | index: |
| findAnchorLinkByHref | [ElementWrapper](../../get-started/testing/core-classes.md) | - | href: |
| findAnchorNavigation | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findAnchorNavigationList | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findAnchors | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[AnchorItemWrapper](https://cloudscape.design/)> | - | - | AnchorItemWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findInfo | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findLink | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findText | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
## General guidelines
...
- Don't use anchor navigation to represent the information architecture of your application. Use [side navigation](../side-navigation/guidelines.md)   instead.
...
- #### Headings
  ...
  - **Mobile:**     You can include the anchor navigation within an [expandable section](../expandable-section/guidelines.md)     . Stack it as the first element of the content area, and collapse the expandable section by default.
- #### Motion
