...
> Source: https://cloudscape.design/components/cards/ (fetched 2026-09-24)

Represents a collection of items.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/cards) [View in demo](https://cloudscape.design/examples/react/cards.html)
...
In its basic usage, the cards component simply allows to display a list of items as a set of containers. It is possible to add extra features to enhance the customer experience: [text-filtering](../text-filter/guidelines.md) and [pagination](../pagination/guidelines.md).

Each of these features can be configured in different ways. In particular, two different patterns emerge:

- Cards with client-side operations: when the list of items to display is not too big, these items can be fetched in their entirety. Filtering and pagination can hence be done synchronously on the client side. This can be implemented using [collection hooks](../../get-started/dev-guides/collection-hooks.md)   . When you are using collection hooks, make sure that the selection is also controlled by the hook.
...
The selection state of cards component is controlled. Set the `selectedItems` property and the `onSelectionChange` listener to store the selected items in the state of your application. Ensure that you update the resource counter in the cards header. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| findHeaderRegion | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Alias for findHeader method for compatibility with previous versions | - |
| findItems | Array<[CardWrapper](https://cloudscape.design/)> | - | - |
...
| findSelectedItems | Array<[CardWrapper](https://cloudscape.design/)> | - | - |
| findTextFilter | [TextFilterWrapper](../text-filter/guidelines.md) &#124; null | - | - | CardWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findCardHeader | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findSections | Array<[CardSectionWrapper](https://cloudscape.design/)> | - | - |
| findSelectionArea | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - | CardSectionWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findContent | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findSectionHeader | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
...
| findHeaderRegion | [ElementWrapper](../../get-started/testing/core-classes.md) | Alias for findHeader method for compatibility with previous versions | - |
| findItems | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[CardWrapper](https://cloudscape.design/)> | - | - |
...
| findSelectedItems | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[CardWrapper](https://cloudscape.design/)> | - | - |
| findTextFilter | [TextFilterWrapper](../text-filter/guidelines.md) | - | - | CardWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findCardHeader | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findSections | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[CardSectionWrapper](https://cloudscape.design/)> | - | - |
| findSelectionArea | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - | CardSectionWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findContent | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findSectionHeader | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
## General guidelines
...
- When used within the [app layout](../app-layout/guidelines.md)   , `full-page`   cards must be the first component in the `content`   slot.
- Cards are dedicated to collections only. Use the [container](../container/guidelines.md)   component with media to present a card-like container with an image.
- Use the [primary link](../link/guidelines.md)   variant instead of the [secondary link](../link/guidelines.md)   variant in cards to help users distinguish links from other surrounding text content.
...
- Don't use sticky header in cards without actions in the [header](../header/guidelines.md)  .
- Don't use sticky header for continuous scrolling. We strongly recommend using [pagination](../pagination/guidelines.md)   to give users an easy and consistent access to all items without scroll.
...
- #### Variant
  ...
  - **Full page**    
    ...
    - This variant takes up the full page. Use for presenting and managing cards on a standalone page. We also suggest enabling the sticky header and using the "awsui-h1-sticky" `variant`       of the [header](../header/guidelines.md)       with this variant, so the title reduces its size on scroll. For further context, see the [card view demo](https://cloudscape.design/examples/react/cards.html)       and the [card view](../../patterns/resource-management/view/card-view.md)       pattern.
- #### Header
  ...
  - **Collection title **    
    ...
    - Use the h1 variant of the [header](../header/guidelines.md)       component to display the title of full page collection in card view.      

      - For example: When used as a [full page card view](https://cloudscape.design/examples/react/cards.html)        .
    - Use the h2 variant of the [header](../header/guidelines.md)       component in the container header of the default cards variant.
  - **Item counter **    
...
- #### Features
  ...
  - **Filtering:**     Filtering allows users to find a specific item, or a subset of items, using one of three [filtering mechanisms](../../patterns/general/filter-patterns.md)     : [text filtering](../text-filter/guidelines.md)     , [collection select filter](../collection-select-filter/guidelines.md)     , or [property filter](../property-filter/guidelines.md)    .
  - **Pagination:** [Pagination](../pagination/guidelines.md)     allows users to paginate through a collection.
  - **Preferences:** [Preferences](../collection-preferences/guidelines.md)     allow users to manage the display of the cards for properties like visible sections and page size.
- #### Cards per row
...
- Follow the writing guidelines for [table description](../table/guidelines.md)  .
