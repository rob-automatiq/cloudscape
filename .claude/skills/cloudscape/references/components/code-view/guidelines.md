...
> Source: https://cloudscape.design/components/code-view/ (fetched 2026-09-24)

Allow users to read and copy a code snippet.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/code-view/tree/main/src/code-view)
...
- Use to display read-only code snippets. For code editing use [code editor](../code-editor/guidelines.md)   instead.

## Features

- #### Action buttons - optional

  Enables users to perform actions, such as copy or download the code snippet. Follow the guidelines for [copy to clipboard](../copy-to-clipboard/guidelines.md)  .
...
- Follow the accessibility guidelines for [buttons](../button/guidelines.md)  .
- Follow the accessibility guidelines for [copy to clipboard.](../copy-to-clipboard/guidelines.md)
