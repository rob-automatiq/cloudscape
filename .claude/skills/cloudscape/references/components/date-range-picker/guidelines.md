...
> Source: https://cloudscape.design/components/date-range-picker/ (fetched 2026-09-24)

With the date range picker, users can specify a date and time range.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/date-range-picker)
...
The date range picker component is controlled. Set the `value` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| --- | --- | --- | --- |
| findDropdown | [DrpDropdownWrapper](https://cloudscape.design/) &#124; null | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | Alias for findTrigger | - |
| findTrigger | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | Returns the trigger element that can be used to open the picker dropdown. | - |
| openDropdown | - | - | - | DrpDropdownWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findApplyButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findCancelButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findClearButton | [ButtonWrapper](../button/guidelines.md) &#124; null | - | - |
| findCurrentDay | [CalendarDateWrapper](https://cloudscape.design/) | Returns the day container that corresponds to the current day. | - |
| findCurrentMonth | [CalendarDateWrapper](https://cloudscape.design/) | Returns the month container that corresponds to the current month. | - |
| findCustomRelativeRangeDuration | [InputWrapper](../input/guidelines.md) &#124; null | - | - |
| findCustomRelativeRangeUnit | [SelectWrapper](../select/guidelines.md) &#124; null | - | - |
| findDateAt | [CalendarDateWrapper](https://cloudscape.design/) | Returns a day container on the calendar. | grid:the calendar grid. If only one calendar grid is visible (on small screens), use `'right'`.row:1-based row index of the day.column:1-based column index of the day. |
| findEndDateInput | [InputWrapper](../input/guidelines.md) &#124; null | - | - |
| findEndTimeInput | [InputWrapper](../input/guidelines.md) &#124; null | - | - |
| findHeader | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findMonthAt | [CalendarDateWrapper](https://cloudscape.design/) | Returns a month container on the calendar. | grid:the calendar grid. If only one calendar grid is visible (on small screens), use `'right'`.row:1-based row index of the month.column:1-based column index of the month. |
...
| findRelativeRangeRadioGroup | [RadioGroupWrapper](../radio-group/guidelines.md) &#124; null | - | - |
| findSelectedEndDate | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findSelectedStartDate | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findSelectionModeSwitch | [SelectionModeSwitchWrapper](https://cloudscape.design/) | - | - |
| findStartDateInput | [InputWrapper](../input/guidelines.md) &#124; null | - | - |
| findStartTimeInput | [InputWrapper](../input/guidelines.md) &#124; null | - | - |
| findValidationError | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLSpanElement> &#124; null | - | - | CalendarDateWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDisabledReason | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - | SelectionModeSwitchWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findModesAsSegments | [SegmentedControlWrapper](../segmented-control/guidelines.md) | Returns the mode selector as a SegmentedControl wrapper.The mode selector is only rendered as a SegmentedControl on wide viewports. On narrow viewports, use findModesAsSelect() instead. | - |
| findModesAsSelect | [SelectWrapper](../select/guidelines.md) | Returns the mode selector as a Select wrapper.The mode selector is only rendered as a Select on narrow viewports. On wide viewports, use findModesAsSegments() instead. | - |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDropdown | [DrpDropdownWrapper](https://cloudscape.design/) | - | options:* expandToViewport (boolean) - Use this when the component under test is rendered with an `expandToViewport` flag. |
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md) | Alias for findTrigger | - |
| findTrigger | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the trigger element that can be used to open the picker dropdown. | - | DrpDropdownWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findApplyButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findCancelButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findClearButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findCurrentDay | [CalendarDateWrapper](https://cloudscape.design/) | Returns the day container that corresponds to the current day. | - |
| findCurrentMonth | [CalendarDateWrapper](https://cloudscape.design/) | Returns the month container that corresponds to the current month. | - |
| findCustomRelativeRangeDuration | [InputWrapper](../input/guidelines.md) | - | - |
| findCustomRelativeRangeUnit | [SelectWrapper](../select/guidelines.md) | - | - |
| findDateAt | [CalendarDateWrapper](https://cloudscape.design/) | Returns a day container on the calendar. | grid:the calendar grid. If only one calendar grid is visible (on small screens), use `'right'`.row:1-based row index of the day.column:1-based column index of the day. |
| findEndDateInput | [InputWrapper](../input/guidelines.md) | - | - |
| findEndTimeInput | [InputWrapper](../input/guidelines.md) | - | - |
...
| findPreviousButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findPreviousMonthButton | [ButtonWrapper](../button/guidelines.md) | Alias for findPreviousButton for compatibility with previous versions. | - |
| findRelativeRangeRadioGroup | [RadioGroupWrapper](../radio-group/guidelines.md) | - | - |
| findSelectedEndDate | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findSelectedStartDate | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findSelectionModeSwitch | [SelectionModeSwitchWrapper](https://cloudscape.design/) | - | - |
| findStartDateInput | [InputWrapper](../input/guidelines.md) | - | - |
| findStartTimeInput | [InputWrapper](../input/guidelines.md) | - | - |
| findValidationError | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - | CalendarDateWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDisabledReason | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - | SelectionModeSwitchWrapper 
...
- The component can be used as a ﬁlter on a collection of items such as [table](../table/guidelines.md)   and [card](../cards/guidelines.md)   . See the demo for [table view with date range picker filter](https://cloudscape.design/examples/react/table-date-filter.html)  .
...
- Follow the guidelines for [timestamps](../../patterns/general/timestamps.md)   to decide which format to use.
- Follow the guidelines for [disabled and read-only states](../../patterns/general/disabled-and-read-only-states.md)  .
- Use custom trigger content to surface contextual metadata. For example, a timezone that helps users interpret the selected range without opening the dropdown.

### Don't

- If a use case does not require users to set a custom absolute or relative range, don't use the date range picker component. Instead, to provide pre-configured relative ranges only, use the [select](../select/guidelines.md)   component.
- Don't use custom trigger content to replicate what the default trigger already provides. Only use it when you need to display additional information beyond the formatted date range.
...
- #### Custom trigger content
  ...
  Use custom trigger content to display additional context alongside the selected date range, such as a timezone indicator. The component provides the formatted date so you can compose around it without reimplementing date formatting.
...
- #### Selection mechanism
  ...
  A [segmented control](../segmented-control/guidelines.md)   that allows users to toggle between selecting a date and time range using the absolute or the relative range.
- #### Absolute range
...
**Date states**  
  ...
  - **Disabled:**     Dates that cannot be selected by the user. For more information about disabled dates, follow the guidelines for [date picker](../date-picker/guidelines.md)    .
...
**Inputs**  
  ...
  - The component uses [time input](../time-input/guidelines.md)     for start and end time and [date picker](../date-picker/guidelines.md)     input for start and end dates.
...
- #### Client side errors
  ...
  If the date and time range applied by users returns an error after client side validation occurs **,**   show a contextual [alert](../alert/guidelines.md)   above the overlay footer to display the error message. For example:  
...
[View Documentation](../../patterns/general/errors/validation.md)
...
- Don't use the description to show constraints on date and time range. Use [constraint text](../form-field/guidelines.md)   instead.
- Avoid directive text that states the obvious, such as *Enter a date and time range*  .
- Follow the writing guidelines for [form field](../form-field/guidelines.md)  .
...
- Follow writing guidelines for [segmented control](../segmented-control/guidelines.md)  .
...
- Follow the writing guidelines for [radio group](../radio-group/guidelines.md)  .
...
- Follow the writing guidelines for [error messages](../../patterns/general/errors/error-messages.md)  .
...
- Follow the accessibility guidelines for [form field](../form-field/guidelines.md)  .
