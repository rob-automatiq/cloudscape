...
> Source: https://cloudscape.design/components/expandable-section/ (fetched 2026-09-24)

With expandable selection, users can expand or collapse a section.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/expandable-section)
...
| findExpandButton | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findExpandedContent | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findExpandIcon | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
...
| findHeaderText | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
...
| findExpandButton | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findExpandedContent | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findExpandIcon | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
...
| findHeaderText | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
## General guidelines
...
- Don't use expandable sections inside tables. Instead use [table with expandable rows](../table/guidelines.md)  .
- Don't use more than one action in a default expandable section header. If you need more, use a [inline icon button dropdown](../button-dropdown/guidelines.md)  .
...
- #### Variant
  ...
  - **Container**     : has its own visual container. It's used within the context of other containers, such as [resource creation flows](../../patterns/resource-management/create.md)     . It also allows for additional optional elements in the header: description, counter, info link, and actions.
...
- #### Actions - optional
  ...
  - **Default: **     Use the [inline button](../button/guidelines.md)     and [inline button dropdown](../button-dropdown/guidelines.md)     . For example, an action to remove a section.
  - **Container: **     Follow the guidelines for [actions in the header](../header/guidelines.md)    .
