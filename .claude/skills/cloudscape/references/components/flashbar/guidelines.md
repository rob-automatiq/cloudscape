...
> Source: https://cloudscape.design/components/flashbar/ (fetched 2026-09-24)
...
Flashbar - Displays one or more status notifications that communicate critical task operation status - errors, success, in-progress, and info. The info flashbar also announces entire service launch in beta or preview.
 ...
 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/flashbar)
...
Flash messages should appear below the top navigation, if your application has it. Place the flashbar component in the `notifications` slot of the [app layout](../app-layout/guidelines.md).

#### State management

The flashbar component is controlled. For dismissible items, set the onDismiss property to store the visible items in the state of your application and update the `items` property. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
We recommend to disable motion in test environments as this may cause your automated tests to fail. You can control the motion state using the [disableMotion()](../../get-started/for-developers/global-styles.md) function from the global styles package.
...
| --- | --- | --- | --- |
| findItemById | [FlashWrapper](https://cloudscape.design/) &#124; null | Returns a flash item by its id.The id is matched against the id property of each item passed to the items property of the Flashbar component. | id: |
| findItems | Array<[FlashWrapper](https://cloudscape.design/)> | Returns the individual flashes of this flashbar.If the items are stacked, only the item at the top of the stack is returned. | - |
| findItemsByType | Array<[FlashWrapper](https://cloudscape.design/)> | Returns the individual flashes of this flashbar given the item type.If the items are stacked, only the item at the top of the stack is returned.If an item is loading its type is considered as "info". | type: |
| findToggleButton | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLButtonElement> &#124; null | Returns the toggle button that expands and collapses stacked notifications. | - | FlashWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findAction | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the action slot. | - |
| findActionButton | [ButtonWrapper](../button/guidelines.md) &#124; null | Returns the action button.The action button is only rendered when the buttonText property is set. | - |
| findContent | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findDismissButton | [ButtonWrapper](../button/guidelines.md) &#124; null | Returns the dismiss button.The dismiss button is only rendered when the dismissible property is set to true. | - |
...
| --- | --- | --- | --- |
| findItemById | [FlashWrapper](https://cloudscape.design/) &#124; null | Returns a flash item by its id.The id is matched against the id property of each item passed to the items property of the Flashbar component. | id: |
| findItems | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[FlashWrapper](https://cloudscape.design/)> | Returns the individual flashes of this flashbar.If the items are stacked, only the item at the top of the stack is returned. | - |
| findItemsByType | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[FlashWrapper](https://cloudscape.design/)> | Returns the individual flashes of this flashbar given the item type.If the items are stacked, only the item at the top of the stack is returned.If an item is loading its type is considered as "info". | type: |
| findToggleButton | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the toggle button that expands and collapses stacked notifications. | - | FlashWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findAction | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the action slot. | - |
| findActionButton | [ButtonWrapper](../button/guidelines.md) | Returns the action button.The action button is only rendered when the buttonText property is set. | - |
| findContent | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findDismissButton | [ButtonWrapper](../button/guidelines.md) | Returns the dismiss button.The dismiss button is only rendered when the dismissible property is set to true. | - |
| findHeader | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
## General guidelines

### Do

- Use flashbars for status notification that communicate task operation status, including errors, success, in-progress, and info.
...
- Stacked notifications will be shown in order of appearance, regardless types of status notifications. Use only one stack for all notifications.
...
- Don't use flashbar for feature notifications follow the guidelines for [Announcing new features](../../patterns/general/announcing-new-features.md)  .
- Don't auto-dismiss the message while the user remains on the same page view.
- Don't show the message on pages where it's not relevant. For example, if the user navigates to a different unrelated page, a flashbar from the previous screen should be automatically dismissed from view.
- Avoid adding links to message headers. If you need to link out to more information, use the content area.
...
- #### Action button - optional
  ...
  The flash message may optionally provide a single [action button](../button/guidelines.md)   . For example, if a resource has just been created, and the user wants to do further configuration of this resource or a related resource, an action button can take the user to the appropriate page to do this, or directly launch the operation.
...
- #### Types
  ...
  - [Error](../../patterns/general/errors/error-messages.md)     - The current action can't be completed.
...
- #### App layout
  ...
  Place the flashbar in the `notification`   region of [app layout](../app-layout/guidelines.md)  .
...
- For loading message, follow the writing guidelines for [loading](../../patterns/general/loading-and-refreshing.md)  .
