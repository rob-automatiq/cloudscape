...
> Source: https://cloudscape.design/components/form-field/ (fetched 2026-09-24)

With the form field, users can create properly-styled controls in a form.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/form-field)
...
If you want to place multiple form fields one after another, use the [space between component](../space-between/guidelines.md) with size `l` to add vertical spacing between them.

If you need to place multiple form fields in a single row, use the [space between component](../space-between/guidelines.md) with size `s` to add horizontal spacing between them.
...
| --- | --- | --- | --- |
| findCharacterCount | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findConstraint | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findControl | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
...
| findSecondaryControl | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findWarning | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findCharacterCount | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findConstraint | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findControl | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
...
| findSecondaryControl | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findWarning | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
## General guidelines

### Do

- Provide a label for every form control. If a Tiles component is the only field in a container, you may omit the `<FormField>`   label and instead reference the container header using `ariaLabelledby`   . This avoids visual redundancy when the container heading already communicates the field's purpose.
- Use [error text](../../patterns/general/errors/error-messages.md)   for server-side validation.
...
- #### Label
  ...
  When a label is supported with an [info link](../link/guidelines.md)   a divider separates the two elements.
