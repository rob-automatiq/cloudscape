...
> Source: https://cloudscape.design/components/popover/ (fetched 2026-09-24)

Provides on-demand contextual information about elements or events.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/popover)
...
- in a [box component](../box/guidelines.md)   with the appropriate `color`   property for common use cases (for example, when the popover trigger is a [status indicator](../status-indicator/guidelines.md)   ).
- in an element with a custom CSS color declaration. Use our [design tokens](../../foundation/visual-foundation/design-tokens.md)   to select a color that is part of the system.
...
| --- | --- | --- | --- |
| findContent | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | options:* renderWithPortal (boolean) - Flag to find the content when the popover is rendered with a portal |
| findDismissButton | [ButtonWrapper](../button/guidelines.md) &#124; null | - | options:* renderWithPortal (boolean) - Flag to find the dismiss button when the popover is rendered with a portal |
| findHeader | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | options:* renderWithPortal (boolean) - Flag to find the header when the popover is rendered with a portal |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findContent | [ElementWrapper](../../get-started/testing/core-classes.md) | - | options:* renderWithPortal (boolean) - Flag to find the content when the popover is rendered with a portal |
| findDismissButton | [ButtonWrapper](../button/guidelines.md) | - | options:* renderWithPortal (boolean) - Flag to find the dismiss button when the popover is rendered with a portal |
| findHeader | [ElementWrapper](../../get-started/testing/core-classes.md) | - | options:* renderWithPortal (boolean) - Flag to find the header when the popover is rendered with a portal |
| findTrigger | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
## General guidelines
...
- Use the [primary link](../link/guidelines.md)   variant instead of the [secondary link](../link/guidelines.md)   variant in popovers to help users distinguish links from other surrounding text content.
- Always use a header when the popover can be dismissed.

### Don't

- Don't use popovers to provide help content. Follow the guidelines for the [help system](../../patterns/general/help-system.md)   instead.
- Don't use popovers for content that requires users to read a lot of  text or focus for long periods of time. Instead, use a [modal](../modal/guidelines.md)   to better focus  users' attention.
- Don't launch a modal from within a popover.
- Don't launch a popover from within a popover.
- Don't include [info links](../link/guidelines.md)   in a popover. Instead, provide help content at page level.
...
- #### Content area
  ...
  Use the content area for text or elements (such as a [Learn more link](../link/guidelines.md)   ) that provide more detail or meta information about the referenced resource, event, or other content.  

  Follow the guidelines for [loading and refreshing](../../patterns/general/loading-and-refreshing.md)   when asynchronously loading content into a popover.
...
- #### Trigger
  ...
  - [Buttons](../button/guidelines.md)     should only be used when the user is initiating a small, self-contained action. The popover then shows the result in-context.    
...
- #### Size
  ...
  - **Large (460px)**     - For large amounts of content    
    ...
    - For example: Displaying detailed information on a resource feature using a [key-value pair](../key-value-pairs/guidelines.md)       list.
...
- For button triggers, follow the guidelines for [button accessibility](../button/guidelines.md)  .
