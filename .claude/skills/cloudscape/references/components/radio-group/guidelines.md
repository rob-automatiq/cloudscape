...
> Source: https://cloudscape.design/components/radio-group/ (fetched 2026-09-24)

Radio group enable users to choose one option from a predefined set.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/radio-group)
...
The radio group component is controlled. Set the `value` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| --- | --- | --- | --- |
| findButtons | Array<[RadioButtonWrapper](../radio-button/guidelines.md)> | - | - |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findButtons | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[RadioButtonWrapper](../radio-button/guidelines.md)> | - | - |
| findInputByValue | [ElementWrapper](../../get-started/testing/core-classes.md) | - | value: |
## General guidelines

### Do

- Use radio group when only one selection can be made from a group of two to seven options. Use [select](../select/guidelines.md)   for groups of eight or more options.
- If one item is selected and disabled, always disable the other items in the radio group.
- Use for a selection between two options that require visible explanation via label and description for both states. Use a [toggle](../toggle/guidelines.md)   or [checkbox](../checkbox/guidelines.md)   if you need to explain only the active state of a boolean option.
- Use for options that turn a group of elements on or off, for example progressive disclosure of form elements. If the group of sub-elements contain other radio groups, use [checkbox](../checkbox/guidelines.md)   , [toggle](../toggle/guidelines.md)   , or [tiles](../tiles/guidelines.md)   instead.
...
- #### Description - optional
  ...
  Use the description to provide a broader explanation of the label. Follow the guidelines for [form field](../form-field/guidelines.md)  .
- #### Vertical layout
...
- Wrap the component in a [form field](../form-field/guidelines.md)   to ensure that the group of radio buttons is correctly labelled. Alternatively, explicitly set properties `ariaLabel`   (or `ariaLabelledBy`   ) and `ariaDescribedBy`  .

#### Labels and descriptions

- Radio button labels and descriptions are part of the clickable/focusable area of the control, so they should not contain interactive content (for example, links). Place links at the [form field](../form-field/guidelines.md)   level instead.
