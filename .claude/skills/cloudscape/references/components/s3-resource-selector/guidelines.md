...
> Source: https://cloudscape.design/components/s3-resource-selector/ (fetched 2026-09-24)
...
S3 resource selector is a component that provides the ability to read objects from an S3 bucket, or write objects to an S3 bucket with a prefix.
 ...
 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/s3-resource-selector)
...
The S3 resource selector component is controlled. Set the `resource` property and the `onChange` listener to store its value and validation result in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| --- | --- | --- | --- |
| findAlertSlot | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findInContext | [S3InContextWrapper](https://cloudscape.design/) | - | - |
| findModal | [S3ModalWrapper](https://cloudscape.design/) &#124; null | - | - |
| findTable | [TableWrapper](../table/guidelines.md) &#124; null | - | - | S3InContextWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findBrowseButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findUriInput | [InputWrapper](../input/guidelines.md) | - | - |
| findVersionsSelect | [SelectWrapper](../select/guidelines.md) &#124; null | - | - |
| findViewButton | [ButtonWrapper](../button/guidelines.md) | - | - | S3ModalWrapper 
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findAlertSlot | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findInContext | [S3InContextWrapper](https://cloudscape.design/) | - | - |
| findModal | [S3ModalWrapper](https://cloudscape.design/) | - | - |
| findTable | [TableWrapper](../table/guidelines.md) | - | - | S3InContextWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findBrowseButton | [ButtonWrapper](../button/guidelines.md) | - | - |
| findUriInput | [InputWrapper](../input/guidelines.md) | - | - |
| findVersionsSelect | [SelectWrapper](../select/guidelines.md) | - | - |
| findViewButton | [ButtonWrapper](../button/guidelines.md) | - | - | S3ModalWrapper 
...
- Don't use the S3 resource selector pattern as a generic file resource selector; instead use the [file upload](../file-upload/guidelines.md)   pattern.
...
- #### Resource URI input
  ...
  - For specific validation text strings, follow the writing guidelines for [S3 resource selector](guidelines.md)    .
...
- Follow the writing guidelines for [modal](../modal/guidelines.md)  .
...
- For table columns with dates or times, follow the guidelines for [timestamps](../../patterns/general/timestamps.md)  .
- Follow the writing guidelines for [table](../table/guidelines.md)  .

#### Component states

#### Empty state

For empty states, such as the *Resource URI * input, *Object version* select, and *browse S3 resources* table, follow the guidelines for [empty states](../../patterns/general/empty-states.md).
...
- Follow the writing guidelines for [alert](../alert/guidelines.md)  .
...
- For the respective parts of the S3 resource selector, reference the alternative text guidelines for [alert](../alert/guidelines.md)   , [breadcrumbs](../breadcrumb-group/guidelines.md)   , [modal](../modal/guidelines.md)   , [table](../table/guidelines.md)   , and [pagination](../pagination/guidelines.md)  .
