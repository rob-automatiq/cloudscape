...
> Source: https://cloudscape.design/components/space-between/ (fetched 2026-09-24)

A helper component that helps you add consistent spacing between elements on your page.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/space-between)
...
Refer to the [information about spacing in our Fundamentals page](../../foundation/visual-foundation/spacing.md) to determine which size of spacing to use.
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| No methods availableThis wrapper does not provide any additional methods. |  |  |  | For usage, see the  <a href="/foundation/visual-foundation/visual-style/"></a> [spacing](../../foundation/visual-foundation/spacing.md) guidelines.
