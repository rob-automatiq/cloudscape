...
> Source: https://cloudscape.design/components/tag-editor/ (fetched 2026-09-24)
...
An extension of the attribute editor built with integrated logic. With the tag editor, users can create, edit, or delete resource tags.
 ...
 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/tag-editor) [View in demo](https://cloudscape.design/examples/react/manage-tags.html)
...
The tag editor component is controlled. Set the `tags` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| findRow | [TagEditorRowWrapper](https://cloudscape.design/) &#124; null | Returns a row for a given index. | row:1-based row index |
| findRows | Array<[TagEditorRowWrapper](https://cloudscape.design/)> | Returns all rows.To find a specific row use the findRow(n) function as chaining findRows().get(n) can return unexpected results. | - | TagEditorRowWrapper 
...
| findUndoButton | [LinkWrapper](../link/guidelines.md) &#124; null | - | - |
...
| findRow | [TagEditorRowWrapper](https://cloudscape.design/) | Returns a row for a given index. | row:1-based row index |
| findRows | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[TagEditorRowWrapper](https://cloudscape.design/)> | Returns all rows.To find a specific row use the findRow(n) function as chaining findRows().get(n) can return unexpected results. | - | TagEditorRowWrapper 
...
| findUndoButton | [LinkWrapper](../link/guidelines.md) | - | - |
## General guidelines

### Do

- Display tag editor in loading state until all resource tags have been  loaded.
- Use the tag editor to manage tags only in [create](../../patterns/resource-management/create.md)   and [edit](../../patterns/resource-management/edit.md)   flows.
...
The tag editor component is an extension of [attribute editor](../attribute-editor/guidelines.md) . It integrates into a service so that your users can manage resource tags.
...
- #### Validation
  ...
  - Validation happens inline for key and value constraints and for empty keys. Follow the [tag editor](guidelines.md)     writing guidelines for specific text strings.
  - For specific validation text strings, follow the [tag editor](guidelines.md)     writing guidelines.
  - For validation rules in form submission, follow the guidelines for [validation](../../patterns/general/errors/validation.md)    .
- #### Loading of tag keys and values

  - Tag keys and values are displayed in the suggestion list. If the dataset fails to load, a message communicating the error is displayed. Follow the guidelines for [autosuggest](../autosuggest/guidelines.md)    .
...
- #### Loading
  ...
  The state of the tag editor while the tags are being loaded. In case of loading failure display an error [alert](../alert/guidelines.md)   communicating to the users the occurred error.
...
- Follow the guidelines for [form field](../form-field/guidelines.md)  .
...
- Follow the guidelines for [autosuggest](../autosuggest/guidelines.md)  .
...
- When the loading of the component fails, use an alert to communicate the occurred error.  
  ...
  - Follow the guidelines for [error alert](../alert/guidelines.md)    .
