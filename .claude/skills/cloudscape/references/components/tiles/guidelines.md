...
> Source: https://cloudscape.design/components/tiles/ (fetched 2026-09-24)
...
Tiles enable users to choose one of a predefined set of options, including additional metadata to facilitate comparisons or progressive disclosure.
 ...
 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/tiles)
...
The tiles component is controlled. Set the `value` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
| --- | --- | --- | --- |
| findInputByValue | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLInputElement> &#124; null | - | value: |
| findItemByValue | [TileWrapper](https://cloudscape.design/) &#124; null | - | value: |
| findItems | Array<[TileWrapper](https://cloudscape.design/)> | - | - | TileWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDescription | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | - | - |
| findImage | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
| findNativeInput | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | - | - |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findInputByValue | [ElementWrapper](../../get-started/testing/core-classes.md) | - | value: |
| findItemByValue | [TileWrapper](https://cloudscape.design/) | - | value: |
| findItems | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[TileWrapper](https://cloudscape.design/)> | - | - | TileWrapper 

| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDescription | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
| findImage | [ElementWrapper](../../get-started/testing/core-classes.md) | - | - |
...
- Use tiles when there are two to seven options in the group. Use a [select](../select/guidelines.md)   or [autosuggest](../autosuggest/guidelines.md)   when there are more than eight options.
- Use for selections that require additional metadata to compare mutually exclusive options. For boolean options that do not require a description of the off state, use a [toggle](../toggle/guidelines.md)   or [checkbox](../checkbox/guidelines.md)   instead.
- When displaying a description, image, or badges to differentiate options, use them on every tile. When using a description, keep the length and sentence structure of descriptions consistent for each tile in a group for easy comparison.
...
- When using badges to display metadata in a tile, add them at the bottom of the description content for better information hierarchy.
...
- Use for options that turn a group of elements on or off, for example progressive disclosure of form elements. If the group of sub-elements contain other [tiles](guidelines.md)   , use [checkbox](../checkbox/guidelines.md)   , [toggle](../toggle/guidelines.md)   , or [radio group](../radio-group/guidelines.md)   instead.
- Always provide an option selected by default.
- Follow the guidelines for [selection in forms](../../patterns/general/selection.md)  .
...
- To prevent multiple click targets in the same area, don't place links  in labels or descriptions. Refer to the [help system](../../patterns/general/help-system.md)   for the  appropriate placement of links.
...
- #### Label
  ...
  Tiles should be labeled to identify the option each represents. Use a [form field](../form-field/guidelines.md)   or other label to identify groups of tiles. Make sure the group label is linked to the tiles both visually and for assistive technology.
- #### Description - optional

  A tile description can be used to define or provide additional context on each tile. They may include lists or badges if necessary.  
  ...
  When tiles represent comparable options, badges can be added at the bottom of the description to show metadata. See the [badge usage guidelines](../badge/guidelines.md)  .
- #### Image - optional
...
- Keep badge text short, one or two words per badge.
- Use nouns or noun phrases, not verbs or sentences. For example: General purpose, vCPU: 4, Memory: 16 GB.
- Use parallel phrasing across badges within the same tile. For example: if one badge uses the format *vCPU: 4*   , apply the same format to related properties: Memory: 16 GB.
...
- Wrap the component in a [form field](../form-field/guidelines.md)   to ensure that the group of tiles is correctly labelled. Alternatively, explicitly set properties `ariaLabel`   (or `ariaLabelledBy`   ) and `ariaDescribedBy`  .

#### Labels and descriptions

- Tile labels and descriptions are part of the clickable/focusable area of the control, so they should not contain interactive content (for example, links). Place links at the [form field](../form-field/guidelines.md)   level instead.
