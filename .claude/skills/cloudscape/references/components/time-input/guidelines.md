...
> Source: https://cloudscape.design/components/time-input/ (fetched 2026-09-24)

A form element in which a user can enter an absolute time value.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/time-input)
...
The time input component is controlled. Set the `value` property and the `onChange` listener to store its value in the state of your application. Learn more about the [state management](../../get-started/dev-guides/state-management.md) of Cloudscape components.
...
- Use time input in forms, such as in [create flow](../../patterns/resource-management/create.md)   and [edit flow](../../patterns/resource-management/edit.md)  .
...
- Don't use a time input for fields that require relative timestamps,  such as *in 30 mins*   . Instead, use [input](../input/guidelines.md)   or [select](../select/guidelines.md)  .
...
- #### Placeholder
  ...
  Follow the guidelines for the [input](../input/guidelines.md)   component for other features.
...
- Follow the writing guidelines for [input](../input/guidelines.md)  .

#### Error text

- Follow the general guidelines for [validation](../../patterns/general/errors/validation.md)  .
