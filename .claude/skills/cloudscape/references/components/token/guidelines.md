...
> Source: https://cloudscape.design/components/token/ (fetched 2026-09-24)

Tokens are a compact representation of an individual item or data point.

 [Get design library](../../get-started/for-designers/design-resources.md) [Browse code](https://github.com/cloudscape-design/components/tree/main/src/token) If you are new to test utility classes, you can learn more in the [introduction article](../../get-started/testing/introduction.md).
...
| --- | --- | --- | --- |
| findDescription | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the token description. | - |
| findDismiss | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the token dismiss button. | - |
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> | Returns the token label. | - |
| findLabelTag | [ElementWrapper](../../get-started/testing/core-classes.md)<HTMLElement> &#124; null | Returns the token label tag. | - |
| findTags | Array<[ElementWrapper](https://cloudscape.design/)> &#124; null | Returns the token tags. | - |
...
| Name | Return type | Description | Parameters |
| --- | --- | --- | --- |
| findDescription | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the token description. | - |
| findDismiss | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the token dismiss button. | - |
| findLabel | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the token label. | - |
| findLabelTag | [ElementWrapper](../../get-started/testing/core-classes.md) | Returns the token label tag. | - |
| findTags | [MultiElementWrapper](../../get-started/testing/core-classes.md)<[ElementWrapper](../../get-started/testing/core-classes.md)> | Returns the token tags. | - |
## General guidelines
...
- Don't use a token to indicate severity of another item. Use [badge](../badge/guidelines.md)   instead.
...
- #### Label tag - optional
  ...
  Label tag is displayed on next to the label, apart from the remaining information. Use it to display a unique piece of information that should stand out, for quicker recollection and decision making. For example, For [file upload](../file-upload/guidelines.md)   , the file size metadata can help to identify the selected files.
