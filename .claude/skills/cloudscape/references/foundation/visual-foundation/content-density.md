...
> Source: https://cloudscape.design/foundation/visual-foundation/content-density/ (fetched 2026-09-24)
...
Comfortable and compact modes are built using the 4px base unit of the [spacing system](spacing.md). In compact mode, the spacing scale is reduced in increments of 4, decreasing the vertical spacing inside components ( *paddings* ) and the vertical and horizontal spacing between components ( *margins* ).
...
When reading help content, browsing on-boarding documentation and getting started, or fixing errors within a form, users need to focus on reading. To help users make decisions without compromising content readability the compact scale is not fully applied to informational components such as [help panel](../../components/help-panel/guidelines.md) , [alert](../../components/alert/guidelines.md) , [flashbar](../../components/flashbar/guidelines.md) , and [form validation messages](../../components/form-field/guidelines.md).

#### Interactivity

When interacting with elements that are contained in a limited real estate, or when focusing on pointing and selecting, space is not a constraint. To not hinder their experience the compact scale is not fully applied to elements with limited target space such as dropdowns in [select](../../components/select/guidelines.md) , [multiselect](../../components/multiselect/guidelines.md) , [autosuggest](../../components/autosuggest/guidelines.md) , [date picker](../../components/date-picker/guidelines.md) , and in [data visualisation](../../patterns/general/data-vis.md) components. It is instead optimised for full page, data intensive views, such as [dashboard](../../patterns/general/service-dashboard.md) , [resource list](../../patterns/resource-management/view.md) , and [resource details](../../patterns/resource-management/details.md).
...
- Ensure users can always switch between comfortable and compact mode. Follow the guidelines for [density settings](../../patterns/general/density-settings.md)  .
...
- Don't apply compact mode to individual pages or standalone components of your application, unless the component specifically offers that capability. For an example, refer to the [table component](../../components/table/guidelines.md) `contentDensity`   property.
...
1. Custom components:
To benefit from the compact mode in your custom components, use the [box](../../components/box/guidelines.md) and [space between](../../components/space-between/guidelines.md) components. You can find more information in our [spacing article](spacing.md).
...
To see an example of the [density settings pattern](../../patterns/general/density-settings.md) implemented, see the [dashboard demo](https://cloudscape.design/examples/react/dashboard.html) . To see compact mode in-action, check out the following demos:
...
[View Documentation](../../patterns/general/density-settings.md)
