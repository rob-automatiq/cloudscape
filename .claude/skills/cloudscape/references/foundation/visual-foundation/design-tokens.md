...
> Source: https://cloudscape.design/foundation/visual-foundation/design-tokens/ (fetched 2026-09-24)
...
For information on design tokens specific for data visualization, see [data visualization colors](data-vis-colors.md).
...
| $color-border-badge-severity-critical | The border color of badges representing a critical severity level. | Yes | transparent | transparent |
| $color-border-badge-severity-high | The border color of badges representing a high severity level. | Yes | transparent | transparent |
| $color-border-badge-severity-medium | The border color of badges representing a medium severity level. | Yes | transparent | transparent |
| $color-border-badge-severity-low | The border color of badges representing a low severity level. | Yes | transparent | transparent |
| $color-border-badge-severity-neutral | The border color of badges representing a neutral severity level. | Yes | transparent | transparent |
| $color-text-badge-severity-critical | The text color of badges representing a critical severity level. | Yes | Aaneutral-100#f9f9fa | Aablack#000000 |
| $color-text-badge-severity-high | The text color of badges representing a high severity level. | Yes | Aaneutral-100#f9f9fa | Aaneutral-950#0f141a |
| $color-text-badge-severity-medium | The text color of badges representing a medium severity level. | Yes | Aaneutral-950#0f141a | Aaneutral-950#0f141a |
| $color-text-badge-severity-low | The text color of badges representing a low severity level. | Yes | Aaneutral-950#0f141a | Aaneutral-950#0f141a |
| $color-text-badge-severity-neutral | The text color of badges representing a neutral severity level. | Yes | Aaneutral-100#f9f9fa | Aaneutral-100#f9f9fa |
| $color-background-badge-icon | The background color of the badge indicator on navigation and panel buttons. | Yes | error-600#db0000 | error-400#ff7a7a |
...
| $color-background-toggle-button-normal-default | The default background color of normal toggle buttons. | Yes | white#ffffff | neutral-850#161d26 |
| $color-background-toggle-button-normal-hover | The background color of normal toggle buttons in hover state. | Yes | primary-50#f0fbff | neutral-800#1b232d |
...
| $color-background-dropdown-item-selected | The background color of selected dropdown items. For example: background of selected items in select, multiselect, autosuggest, and datepicker dropdowns. | Yes | primary-50#f0fbff | primary-1000#001129 |
...
| $color-background-side-navigation-item-active | The background color of an active (highlighted) side navigation item. | Yes | transparent | transparent |
...
| $color-background-backdrop | The background color of the backdrop shown behind overlay surfaces such as modals and drawers. | Yes | grey-opaque-70rgba(35, 43, 55, 0.7) | grey-opaque-70rgba(15, 20, 26, 0.7) |
| $color-background-layout-panel | The background color of the selected (active) drawer panel in the app layout. Use this token to theme the background of the open drawer. | Yes | white#ffffff | neutral-850#161d26 |
| $color-background-layout-toolbar | The background color of the app layout's toolbar. For example: The toolbar bar containing breadcrumbs and toggle buttons. | Yes | white#ffffff | neutral-850#161d26 |
...
| $color-background-flashbar-success | The background color of success flash messages. | Yes | success-600#00802f | success-600#00802f |
| $color-background-flashbar-error | The background color of error flash messages. | Yes | error-600#db0000 | error-600#db0000 |
| $color-background-flashbar-info | The background color of info and in-progress flash messages. | Yes | info-600#006ce0 | info-600#006ce0 |
| $color-background-flashbar-warning | The background color of warning flash messages. | Yes | warning-400#ffe347 | warning-400#ffe347 |
...
| $color-background-segment-wrapper | The background color of segmented control wrapper. | Yes | white#ffffff | neutral-850#161d26 |
...
| $color-background-tiles-disabled | The background color of disabled tiles. | Yes | neutral-250#ebebf0 | neutral-800#1b232d |
...
| $color-background-toggle-default | The default background color of the toggle track in its unchecked state. | Yes | neutral-650#424650 | neutral-500#8c8c94 |
...
| $color-border-toggle-button-normal-default | The default border color of normal toggle buttons. | Yes | primary-600#006ce0 | primary-400#42b4ff |
| $color-border-toggle-button-normal-hover | The border color of normal toggle buttons in hover state. | Yes | primary-900#002b66 | primary-300#75cfff |
...
| $color-border-button-primary-active | The border color of primary buttons in active state. | Yes | primary-900#002b66 | primary-400#42b4ff |
| $color-border-button-primary-default | The border color of primary buttons. | Yes | primary-600#006ce0 | primary-400#42b4ff |
...
| $color-border-button-primary-hover | The border color of primary buttons in hover state. | Yes | primary-900#002b66 | primary-300#75cfff |
...
| $color-text-side-navigation-item-active | The text color of an active (highlighted) side navigation item. | Yes | Aaprimary-600#006ce0 | Aaprimary-400#42b4ff |
...
| $color-border-layout-side-navigation | The border color of the side navigation divider in the app layout. | Yes | neutral-350#c6c6cd | neutral-650#424650 |
...
| $color-border-segment-divider | The color of the dividers between segments in a segmented control. | Yes | neutral-500#8c8c94 | neutral-600#656871 |
| $color-border-segment-hover | Deprecated - this token is no longer in use. | Yes | neutral-650#424650 | neutral-300#dedee3 |
| $color-border-segment-wrapper | The border color of the segmented control wrapper. | Yes | neutral-500#8c8c94 | neutral-600#656871 |
...
| $color-shadow-toggle-handle | The color of the drop shadow under the toggle handle. | Yes | rgba(0, 0, 0, 0.25) | rgba(0, 0, 0, 0.25) |
...
| $color-text-calendar-date-selected | The text color of selected dates in the calendar. | Yes | Aawhite#ffffff | Aaneutral-850#161d26 |
...
| $color-text-dropdown-item-secondary | The text color of secondary information in dropdown items. For example: descriptions and tags text color in a select, multiselect, and autosuggest. | Yes | Aaneutral-600#656871 | Aaneutral-450#a4a4ad |
...
| $color-text-expandable-section-default | The default color of the expandable section header text. | Yes | Aaneutral-950#0f141a | Aaneutral-300#dedee3 |
| $color-text-expandable-section-hover | The color of the expandable section header text in hover state. | Yes | Aaprimary-600#006ce0 | Aaprimary-400#42b4ff |
| $color-text-expandable-section-navigation-icon-default | The default color of the expand icon in the navigation variant of the expandable section. | Yes | Aaneutral-650#424650 | Aaneutral-300#dedee3 |
...
| $color-text-icon-subtle | The color of subtle icons. For example: secondary icons with lower visual emphasis. | Yes | Aaneutral-600#656871 | Aaneutral-400#b4b4bb |
...
| $color-text-link-decoration-default | The default color of the text decoration (underline) of links. Defaults to the link text color. | Yes | AacurrentColor | AacurrentColor |
| $color-text-link-decoration-hover | The hover color of the text decoration (underline) of links. Defaults to the link hover text color. | Yes | AacurrentColor | AacurrentColor |
...
| $color-text-notification-yellow | The text and foreground color used on warning flash messages (yellow notification surface). | Yes | Aaneutral-950#0f141a | Aaneutral-950#0f141a |
...
| $color-background-action-card-default | The default background color of action cards. | Yes | white#ffffff | neutral-850#161d26 |
| $color-background-action-card-hover | The background color of action cards in hover state. | Yes | primary-50#f0fbff | neutral-800#1b232d |
| $color-background-action-card-active | The background color of action cards in active state. | Yes | primary-100#d1f1ff | neutral-700#333843 |
| $color-border-action-card-default | The default border color of action cards. | Yes | primary-600#006ce0 | primary-400#42b4ff |
| $color-border-action-card-hover | The border color of action cards in hover state. | Yes | primary-900#002b66 | primary-300#75cfff |
| $color-border-action-card-active | The border color of action cards in active state. | Yes | primary-900#002b66 | primary-300#75cfff |
| $color-border-action-card-disabled | The border color of action cards in disabled state. | Yes | neutral-400#b4b4bb | neutral-600#656871 |
| $color-background-action-card-disabled | The background color of action cards in disabled state. | Yes | white#ffffff | neutral-850#161d26 |
| $color-text-action-card-disabled | The text color of action cards in disabled state. | Yes | Aaneutral-500#8c8c94 | Aaneutral-500#8c8c94 |
| $color-text-action-card-icon-default | The default color of icons in action cards. | Yes | Aaprimary-600#006ce0 | Aaprimary-400#42b4ff |
| $color-text-action-card-icon-hover | The color of icons in action cards in hover state. | Yes | Aaprimary-900#002b66 | Aaprimary-300#75cfff |
| $color-text-action-card-icon-active | The color of icons in action cards in active state. | Yes | Aaprimary-900#002b66 | Aaprimary-300#75cfff |
| $color-text-action-card-icon-disabled | The color of icons in action cards in disabled state. | Yes | Aaneutral-400#b4b4bb | Aaneutral-600#656871 |
| $color-background-badge-green | The background color of green badges. | Yes | success-600#00802f | success-600#00802f |
| $color-background-badge-blue | The background color of blue badges. | Yes | info-600#006ce0 | info-600#006ce0 |
| $color-background-badge-red | The background color of red badges. | Yes | error-600#db0000 | error-600#db0000 |
| $color-background-badge-yellow | The background color of yellow badges. | Yes | warning-400#ffe347 | warning-400#ffe347 |
| $color-background-badge-grey | The background color of grey badges. | Yes | neutral-650#424650 | neutral-600#656871 |
| $color-border-badge | The default border color of badges. | Yes | transparent | transparent |
| $color-border-badge-grey | The border color of grey badges. | Yes | transparent | transparent |
| $color-border-badge-green | The border color of green badges. | Yes | transparent | transparent |
| $color-border-badge-blue | The border color of blue badges. | Yes | transparent | transparent |
| $color-border-badge-red | The border color of red badges. | Yes | transparent | transparent |
| $color-text-badge-grey | The text color of grey badges. | Yes | Aaneutral-100#f9f9fa | Aaneutral-100#f9f9fa |
| $color-text-badge-green | The text color of green badges. | Yes | Aaneutral-100#f9f9fa | Aaneutral-100#f9f9fa |
| $color-text-badge-blue | The text color of blue badges. | Yes | Aaneutral-100#f9f9fa | Aaneutral-100#f9f9fa |
| $color-text-badge-red | The text color of red badges. | Yes | Aaneutral-100#f9f9fa | Aaneutral-100#f9f9fa |
| $color-background-code-view | The background color of the code view component. | Yes | #f8f8f8 | #282c34 |
### Typography  (47)
...
| $font-size-display-xl | The default font size for extra large display text. | Yes | 64px |
...
| $font-weight-bold | The default bold font weight for body text. For example, <strong> and <b> tags in text content. | Yes | 700 |
| $font-weight-button | The default font weight for button text. | Yes | 700 |
| $font-weight-display-l | The default font weight for large display text. | Yes | 700 |
| $font-weight-display-xl | The default font weight for extra large display text. | Yes | 400 |
...
| $font-weight-heavy | The default heavy font weight. | Yes | 700 |
| $font-weight-lighter | The default lighter font weight. | Yes | 300 |
| $font-weight-normal | The default normal font weight. | Yes | 400 |
...
| $letter-spacing-display-xl | The default letter spacing for extra large display text. | Yes | -0.03em |
...
| $line-height-display-xl | The default line height for extra large display text. | Yes | 72px |
...
| $space-token-vertical | The vertical padding inside tokens. | Yes | 4px | 2px |
| $space-field-vertical | The vertical padding inside control components. | Yes | 5px | 3px |
...
| $space-side-navigation-item-default-gap | The vertical gap between side navigation items when no item has an icon. | Yes | 0px | 0px |
| $space-side-navigation-item-icon-gap | The vertical gap between side navigation items when at least one item has an icon. | Yes | 4px | 4px |
| $space-action-card-horizontal-default | The default horizontal padding inside an action card. | Yes | 20px | 20px |
| $space-action-card-horizontal-embedded | The horizontal padding inside an embedded action card. | Yes | 12px | 10px |
| $space-action-card-vertical-default | The default vertical padding inside an action card. | Yes | 16px | 12px |
| $space-action-card-vertical-embedded | The vertical padding inside an embedded action card. | Yes | 10px | 8px |
| $space-option-padding-vertical | The vertical padding inside dropdown option items. | No | 4px | 4px |
| $space-option-padding-horizontal | The horizontal padding inside dropdown option items. | No | 20px | 20px |
...
| $motion-duration-tooltip-enter | The duration for the tooltip enter transition. | Yes | 115ms |
| $motion-easing-tooltip-enter | The easing curve for the tooltip enter transition. | Yes | cubic-bezier(0, 0, 0, 1) |
| $motion-keyframes-fade-in | The CSS keyframes for showing an element. | No | awsui-fade-in-jiml2r |
| $motion-keyframes-fade-out | The CSS keyframes for hiding an element. | No | awsui-fade-out-au27m5 |
| $motion-keyframes-status-icon-error | The CSS keyframes applied to an error status icon to draw the user's attention. | No | awsui-status-icon-error-mjjk3s |
| $motion-keyframes-scale-popup | The CSS keyframes for scaling up an element to draw the user's attention. | No | awsui-scale-popup-2m9987 |
### Borders  (50)
...
| $border-radius-chat-bubble | The border radius of chat bubbles. | Yes | 8px |
| $border-radius-support-prompt | The border radius of support prompts. | Yes | 8px |
...
| $border-radius-token-inline | The border radius of inline tokens. For example: multiselect component. | Yes | 4px |
| $border-radius-tutorial-panel-item | The border radius of tutorials inside a tutorial panel. | Yes | 8px |
| $border-width-action-card-active | The border width of action cards in active state. | Yes | 1px |
| $border-width-action-card-default | The border width of action cards in default state. | Yes | 1px |
| $border-width-action-card-disabled | The border width of action cards in disabled state. | Yes | 1px |
| $border-width-action-card-hover | The border width of action cards in hover state. | Yes | 1px |
...
| $border-width-flashbar-inline-start | The inline-start border width of flash messages in flashbars. | Yes | 0px |
...
| $border-width-icon-x-small | The visual stroke width of extra small icons. | Yes | 1.5px |
| $border-width-item-selected | The border width of selected items, like table rows. | Yes | 2px |
| $border-width-layout-side-navigation | The border width of the side navigation divider in the AppLayout and AppLayoutToolbar components. | Yes | 1px |
| $border-width-badge | The border width of badges. | Yes | 0px |
...
| Name | Description | Themeable | Value | Light mode | Dark mode | Comfortable mode | Compact mode |
| --- | --- | --- | --- | --- | --- | --- | --- |
| $size-vertical-input | The height of form input components. For example: input, select, multiselect, autosuggest, and datepicker. | Yes |  |  |  | 32px | 28px |
| $size-side-navigation-item-height | The minimum height of side navigation items. | Yes |  |  |  | 28px | 24px |
| $size-side-navigation-item-collapsed | The square size of collapsed side navigation items. | Yes |  |  |  | 30px | 28px |
| $size-side-navigation-collapsed-width | The default width of the collapsed side navigation rail. | Yes |  |  |  | 52px | 52px |
...
Design tokens which can be used for [theming](theming.md) are marked as "Themeable" in the [tokens tables](design-tokens.md) below.

## Development guidelines

Our design tokens are available from a separate package called `design-tokens` and are intended to be used together with Cloudscape components. If you do not have components installed, see our [installation article](../../get-started/for-developers/using-cloudscape-components.md) . All of our tokens are available as [Sass](https://sass-lang.com/documentation/variables) variables (e.g. `$color-text-body-secondary` ) or JavaScript variables (e.g. `colorTextBodySecondary` ).
...
The design tokens package can only be used together with the components package. For detailed instructions, see the [package installation guide](../../get-started/for-developers/using-cloudscape-components.md).
...
Refer to the [Visual Contexts article](visual-context.md) for more information about `contexts`.
