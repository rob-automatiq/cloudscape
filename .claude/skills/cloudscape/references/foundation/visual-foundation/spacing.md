...
> Source: https://cloudscape.design/foundation/visual-foundation/spacing/ (fetched 2026-09-24)
...
A grid system is an ordering system. It sets the measurements used to space and size objects within a given format. It provides a consistent set of rules that is used to define the [grid](../../components/grid/guidelines.md) , the [spacing system](spacing.md) , [typography](typography.md) , and the [iconography system](iconography.md) . All these foundational elements come together to build up the layout, and use the grid system to bring consistency and visual coherence between them.
...
Our design system follows a a soft grid approach which allows more flexibility and is more closely aligned to how websites are built. Use the [spacing system](spacing.md) to lay your content and achieve a consistent vertical rhythm on the pages of your application.
...
| --- | --- | --- | --- |
| xxx-small | 2 |  | Vertical space between a container [header](../../components/header/guidelines.md) and its description |
| xx-small | 4 |  | Vertical space between [form field](../../components/form-field/guidelines.md) label and control |
| x-small | 8 |  | Horizontal space between [buttons](../../components/button/guidelines.md) in an action stripeHorizontal space between [tokens](../../components/token-group/guidelines.md) in a [property filter](../../components/property-filter/guidelines.md)Horizontal space between [checkbox](../../components/checkbox/guidelines.md)/[radio button](../../components/radio-group/guidelines.md) and their respective labels |
| small | 12 |  | Vertical padding inside a [popover](../../components/popover/guidelines.md) |
| medium | 16 |  | Horizontal padding inside a [popover](../../components/popover/guidelines.md)Vertical space inside individual [cards](../../components/cards/guidelines.md)Vertical space between a page [header](../../components/header/guidelines.md) and [content](../../components/content-layout/guidelines.md) |
| large | 20 |  | [Grid](../../components/grid/guidelines.md) gutter width (fixed)Horizontal padding inside a [container](../../components/container/guidelines.md)Vertical space between [form fields](../../components/form-field/guidelines.md) |
| x-large | 24 |  | Vertical space between tasks in a [tutorial panel](../../components/tutorial-panel/guidelines.md) |
| xx-large | 32 |  | Left indentation of grouped options in a [select](../../components/select/guidelines.md) |
| xxx-large | 40 |  | Horizontal padding for [app layout](../../components/app-layout/guidelines.md) and [split panel](../../components/split-panel/guidelines.md) content on large screens |
## Key concepts
...
The [box component](../../components/box/guidelines.md) allows to display and style basic elements and containers in compliance with the typography and spacing strategy of the design system. You can control the padding, margin and floating properties of an element by defining the unit of the spacing scale you would like to apply.

### Space between component

The [space between component](../../components/space-between/guidelines.md) lets you to define equal vertical or horizontal spacing among a group of similar components. Some examples are:
...
You can use the spacing values directly in your styles with [spacing design tokens](design-tokens.md).

[View Documentation](design-tokens.md)
