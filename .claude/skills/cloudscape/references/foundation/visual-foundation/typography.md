...
> Source: https://cloudscape.design/foundation/visual-foundation/typography/ (fetched 2026-09-24)
...
| --- | --- | --- | --- | --- | --- | --- |
| Heading x-large | Open Sans | 24px | 30px | Bold | h1 | Page title |
| Heading large | Open Sans | 20px | 24px | Bold | h2 | [Container](../../components/container/guidelines.md) title |
| Heading medium | Open Sans | 18px | 22px | Bold | h3 | [Card](../../components/cards/guidelines.md) section header[Key/value pair](../../components/key-value-pairs/guidelines.md) column title[Help panel](../../components/help-panel/guidelines.md) section header |
| Heading small | Open Sans | 16px | 20px | Bold | h4 | Paragraph title |
| Heading x-small | Open Sans | 14px | 18px | Bold | h5 | Sections within a paragraph |
### Body styles
...
| Style | Typeface | Font size | Line height | Font weight | Default tag | Examples |
| --- | --- | --- | --- | --- | --- | --- |
| Body medium | Open Sans | 14px | 20px | Normal | p | Body and paragraph text. |
| Body small | Open Sans | 12px | 16px | Normal | small | Description text, constraint text, and errors within form fields and form elementsStep labels within a [wizard](../../components/wizard/guidelines.md) |
### Code styles
...
| Style | Typeface | Font size | Line height | Font weight | Default tag | Examples |
| --- | --- | --- | --- | --- | --- | --- |
| Code | Monaco, Menlo, Consolas, Courier Prime, Courier, Courier New, monospace | 12px | 16px | Normal | code | Displaying code or computer output |
| Preformatted | Monaco, Menlo, Consolas, Courier Prime, Courier, Courier New, monospace | 14px | 20px | Normal | pre | Displaying preformatted blocks of code |
### Display styles
...
| Style | Typeface | Font size | Line height | Font weight | Default tag | Examples |
| --- | --- | --- | --- | --- | --- | --- |
| Display large bold | Open Sans | 42px | 48px | Bold | - | Title on a homepageNumber highlights in a [dashboard](../../patterns/general/service-dashboard.md) |
| Display large light | Open Sans | 42px | 48px | Light | - | Subheading on a homepage |
## Fallback fonts
...
- For accessible use of font colors, see [colors](colors.md)  .
...
With the [box component](../../components/box/guidelines.md) , you can display and style basic elements and containers in compliance with the typography and spacing strategy of the system.
...
[View Documentation](../../components/box/guidelines.md)

### Text content

With the [text content component](../../components/text-content/guidelines.md) , you can style chunks of HTML that contain basic elements ( `h1` , `h2` , `h3` , `h4` , `h5` , `p` , `strong` , `small` , `code` , `pre` , `samp` , `ul` , `ol` , `a` ). You can use it as an alternative to the box component when you can't convert every single basic element to a component. For example, HTML from a content management system, or the output of Markdown file. Unlike the box component, you can use the text component to style lists ( `ul` , `ol` ) and anchors ( `a` ) that are contained in the text.

[View Documentation](../../components/text-content/guidelines.md)
