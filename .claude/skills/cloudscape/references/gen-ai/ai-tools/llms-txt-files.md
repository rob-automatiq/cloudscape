...
> Source: https://cloudscape.design/gen-ai/ai-tools/llms-txt-files/ (fetched 2026-09-24)

Learn how to use Cloudscape Design System documentation with your AI tools and agents.

## Introduction

Cloudscape makes its documentation, component specifications, and demos available in markdown format, enabling AI agents to generate consistent Cloudscape aligned interfaces. Cloudscape provides each documentation page formatted in Markdown for Large Language Models (LLMs). AI agents and MCP servers discover these pages by using our [LLMs.txt](https://cloudscape.design/llms.txt) file.
...
```
"Use the Cloudscape Design System documentation at https://cloudscape.design/llms.txt to help me implement a table with filtering capabilities."
```

```
"I'm building a web interface. Using the Cloudscape Design System (https://cloudscape.design/llms.txt), help me create an alert component for error messages use https://cloudscape.design/components/alert/index.html.json and https://cloudscape.design/components/alert/index.html.md for ensuring the code is valid and implement production code, maintainable, and well tested"
```

For better results use the following rules in your steering files. They will be sent in every prompt:

```
# Cloudscape Rules
  - Import from @cloudscape-design/components"
  - Read https://cloudscape.design/get-started/for-developers/start-developing/ before start coding
  - When creating new applications, You MUST not use create-react-app, You MUST use instead `npm create vite@latest`
```
