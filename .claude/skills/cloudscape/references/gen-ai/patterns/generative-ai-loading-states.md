...
> Source: https://cloudscape.design/gen-ai/patterns/generative-ai-loading-states/ (fetched 2026-09-24)
...
[View Documentation](../../components/avatar/guidelines.md)

### Loading bar

A linear loading indicator that informs the user about an ongoing operation with unknown duration.

[View Documentation](../../components/loading-bar/guidelines.md)
...
When generative AI is in processing stage upon receiving a prompt from the user in a conversation, display a loading indicator like the [avatar](../../components/avatar/guidelines.md) with loading text in the chat bubble next to it. When additional reasoning occurs during this stage, such as evaluating approaches or cross-referencing information, display this deliberation to users using the [thinking](thinking.md) pattern.
  ...
  return (
    <Container header={<Header variant="h3">Generative AI assistant</Header>}>
      <SpaceBetween size="xs">
        <ChatBubble
          type="outgoing"
          ariaLabel="Jane Doe at 05:35:10pm"
        ...
        <ChatBubble
          type="incoming"
          ariaLabel="Generative AI assistant at 05:35:15pm"
          avatar={
            <Avatar
  ...
  return (
    <Container header={<Header variant="h3">Generative AI assistant</Header>}>
      <SpaceBetween size="xs">
        <ChatBubble
          type="outgoing"
          ariaLabel="Jane Doe at 05:37:30pm"
          avatar={<Avatar initials="JD" tooltipText="Jane Doe" ariaLabel="Jane Doe" />}
        >
          What can I do with Amazon S3?
        </ChatBubble>
        ...
        <ChatBubble
          type="incoming"
          ariaLabel="Generative AI assistant at 05:37:35pm"
          avatar={
            <Avatar
              tooltipText="Generative AI assistant"
              ariaLabel="Generative AI assistant"
        ...
        >
          Amazon S3 (Simple Storage Service) is a highly scalable, durable, and secure object storage service offered by
...
When generative AI moves to generation stage in a conversation, and the response includes other UI elements such as list of resources, table, or code block display the [loading bar](../../components/loading-bar/guidelines.md) with adjacent loading text. Consider the following factors:
...
export default function LoadingWithLoadingBar() {
  return (
    <Container header={<Header variant="h3">Generative AI assistant</Header>}>
      <SpaceBetween size="xs">
        <ChatBubble
          type="outgoing"
          ariaLabel="Jane Doe at 05:32:20pm"
          avatar={<Avatar initials="JD" tooltipText="Jane Doe" ariaLabel="Jane Doe" />}
        >
        ...
        <ChatBubble
          type="incoming"
          ariaLabel="Generative AI assistant at 05:32:27pm"
          showLoadingBar={true}
          hideAvatar={true}
          avatar={
            <Avatar
        ...
        >
          <Box color="text-status-inactive">Loading list of EC2 instances</Box>
        </ChatBubble>
      </SpaceBetween>
    </Container>
  );
...
- **Reserve streaming for text and inline code snippets only**  
  Display the loading state for generative AI complimentary to the type of content it is returning to the user. If the response includes several types of content such as text, inline code snippets, individual [code blocks](../../components/code-view/guidelines.md)   , and [tables](../../components/table/guidelines.md)   , apply streaming to text and inline code snippets only. Show the [loading bar](../../components/loading-bar/guidelines.md)   for other content types such as tables, and code blocks.
...
Follow guidelines for [avatar](../../components/avatar/guidelines.md) and [loading bar](../../components/loading-bar/guidelines.md).
