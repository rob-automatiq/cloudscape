...
> Source: https://cloudscape.design/gen-ai/patterns/shortcut-menus/ (fetched 2026-09-24)
...
- Use [groups](../../components/autosuggest/guidelines.md)   and descriptive labels to separate different kinds of menu items.
...
- Follow [writing guidelines for icon button](../../components/button/guidelines.md)  .
...
[Page](generative-ai-chat.md)

### Prompt input

Enables users to provide a prompt or command.

[View Documentation](../../components/prompt-input/guidelines.md)
