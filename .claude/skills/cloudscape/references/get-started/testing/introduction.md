...
> Source: https://cloudscape.design/get-started/testing/introduction/ (fetched 2026-09-24)

You can test your application by interacting with Cloudscape components.

## Introduction

When creating automated tests for your application you interact with Cloudscape components. For example, you choose a Cloudscape [button](../../components/button/guidelines.md) and assert the application updates to reflect the button's `onClick` action.
...
- [Table](../../components/table/guidelines.md)
- [Property filter](../../components/property-filter/guidelines.md)
- [Autosuggest](../../components/autosuggest/guidelines.md)
- [Modal](../../components/modal/guidelines.md)
