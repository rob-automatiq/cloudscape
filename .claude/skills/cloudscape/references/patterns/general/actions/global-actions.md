...
> Source: https://cloudscape.design/patterns/general/actions/global-actions/ (fetched 2026-09-24)
...
| --- | --- | --- | --- |
|  | Item 1 | First | 1A | This is the first item |
|  | Item 2 | Second | 1B | This is the second item | **Global action locations**

Place global actions in the action stripe of the [header](../../../components/header/guidelines.md) component at the top of the page, or as part of the [table](../../../components/table/guidelines.md) or [cards](../../../components/cards/guidelines.md) header. Add actions as [buttons](../../../components/button/guidelines.md) or [button dropdowns](../../../components/button-dropdown/guidelines.md) if users can perform actions on the underlying content.
...
- For large action sets or where expandable groups in button dropdowns makes it hard for users to scan the full list, enable filtering.

On mobile viewports with more than one non-primary action, consider moving these actions into a button dropdown to conserve space. Follow the guidelines for [responsive design](../../../foundation/core-principles/responsive-design.md).
...
- Actions that do not relate to one resource should be placed in the page header, or as part of the [table](../../../components/table/guidelines.md)   or [cards](../../../components/cards/guidelines.md)   header.  For example: A primary action in the table header to create a new resource.
...
[View Documentation](incontext-actions.md)
