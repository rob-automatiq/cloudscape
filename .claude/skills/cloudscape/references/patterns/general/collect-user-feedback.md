...
> Source: https://cloudscape.design/patterns/general/collect-user-feedback/ (fetched 2026-09-24)
...
User feedback enables users to directly and quickly express their thoughts, concerns, and suggestions about the page they are viewing.
 ...
 [Get design library](../../get-started/for-designers/design-resources.md)
## Features
...
The custom area enables you to append supplementary elements to collect qualitative data, such as a [link](../../components/link/guidelines.md) , an [expandable section](../../components/expandable-section/guidelines.md) , or an embedded form. Follow the guidelines for [custom area](collect-user-feedback.md).
...
Show the loading state while the feedback is being submitted. Follow the guidelines for [button loading state](../../components/button/guidelines.md).
...
Show the error state when the data fails at storing or communicating with the server. You can provide a recovery mechanism, such as a reset action, in the error state. Follow the guidelines for [status indicator](../../components/status-indicator/guidelines.md).
...
- A [link](../../components/link/guidelines.md)   to redirect to a form, either in a [modal](../../components/modal/guidelines.md)   or in a new page.
- An [expandable section](../../components/expandable-section/guidelines.md)   to display a simple form.
- An embedded simple form composed of a header, [form fields](../../components/form-field/guidelines.md)   , and a submit [button](../../components/button/guidelines.md)  .
...
- Ask 1-3 additional questions using form fields, such as an open response [text area](../../components/textarea/guidelines.md)   , a [radio group](../../components/radio-group/guidelines.md)   or [checkboxes](../../components/checkbox/guidelines.md)   , within the expandable section or within an embedded form.
...
Yes No [Provide more feedback]()
## With expandable section

## Was this page helpful?

Yes No Tell us more Additional notes - *optional* Do not disclose any personal, commercially sensitive, or confidential information. Send
## With embedded form
...
- We recommend to place user feedback in close proximity of [anchor navigation](../../components/anchor-navigation/guidelines.md)   , directly below it. It provides users relevant information and it helps to conserve space.

### Don't

- Don't place multiple expandable sections or embedded forms in the custom area.
- Don't use to collect generative AI feedback. Instead, follow the guidelines for [generative AI chat](../../gen-ai/patterns/generative-ai-chat.md)  .
...
- Wrap the error state message in a [live region component](../../components/live-region/guidelines.md)   to notify screen readers about the error.

#### Button

- Follow the accessibility guidelines for [button](../../components/button/guidelines.md)  .

#### Expandable section

- Follow the accessibility guidelines for [expandable section](../../components/expandable-section/guidelines.md)  .

#### Form fields

- Follow the accessibility guidelines for [form field](../../components/form-field/guidelines.md)  .

#### Modal

- Follow the accessibility guidelines for [modal](../../components/modal/guidelines.md)  .
