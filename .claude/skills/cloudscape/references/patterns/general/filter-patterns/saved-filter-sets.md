...
> Source: https://cloudscape.design/patterns/general/filter-patterns/saved-filter-sets/ (fetched 2026-09-24)

Enable users to save filter configurations as filter sets and quickly apply them in a collection of resources.

 [View demo](https://cloudscape.design/examples/react/table-saved-filters.html)
## Key UX concepts

### Streamline filtering process

Setting customized filter configurations on every visit in the [table](../../../components/table/guidelines.md) or [cards](../../../components/cards/guidelines.md) view is a repetitive task for users. By saving the configuration as filter sets, users can reuse the saved filter sets, and quickly apply them in the collection view. This increases work agility, enhances work efficiency, and reduces cognitive memory load when users revisit the collection view.
...
- Limit the amount of filter controls provided in the collection view when using saved filter sets feature. Use property filter to filter for additional properties such as [date](../../../components/property-filter/guidelines.md)   or [properties in custom form](../../../components/property-filter/guidelines.md)  .
- Include [auto filtering](../../../components/select/guidelines.md)   in the saved filter sets dropdown for large number of filter sets.
...
After users apply filters to the collection view, they can save the configuration via the save button in the actions dropdown. Display a modal with [form fields](../../../components/form-field/guidelines.md) for users to:
...
- Display an error message when the name doesn't match the constraint requirements.  
  ...
  - Follow the guidelines for [form field](../../../components/form-field/guidelines.md)     and [validation](../errors/validation.md)    .

Display a success or error [flashbar](../../../components/flashbar/guidelines.md) to communicate the outcome of the operation.
...
Display a [flashbar](../../../components/flashbar/guidelines.md) to communicate the outcome of the operation.

### Delete current filter set

Users can delete the saved filter set when it is no longer relevant for their task completion. A delete action is provided in the action dropdown, and users can confirm the [deletion with a simple confirmation](../../resource-management/delete/delete-with-simple-confirmation.md) modal.
...
Include a select to host the filter sets via `customControl` in [property filter](../../../components/property-filter/guidelines.md).

#### B. Filter set actions

Use a normal [button dropdown](../../../components/button-dropdown/guidelines.md) with main action to display clear, save, update, and delete actions via `customFilterActions` in [property filter](../../../components/property-filter/guidelines.md).

#### C. Property filter

Users can apply saved filter set to a collection view in [property filter](../../../components/property-filter/guidelines.md).

#### D. Filter set settings - optional

Use [selectable items](../../../components/button-dropdown/guidelines.md) in the filter set actions dropdown to display "set as default" filter settings.
...
- Follow the writing guidelines for [button dropdown](../../../components/button-dropdown/guidelines.md)  .
...
- Follow the writing guidelines for [alert](../../../components/alert/guidelines.md)  .
...
- Follow the writing guidelines for [modal](../../../components/modal/guidelines.md)  .
...
- Follow the accessibility guidelines for [property filter](../../../components/property-filter/guidelines.md)   and [button dropdown](../../../components/button-dropdown/guidelines.md)  .
...
[View Documentation](../../../components/property-filter/guidelines.md)
...
[View Documentation](../../../components/collection-select-filter/guidelines.md)
...
[View Documentation](../filter-patterns.md)
