...
> Source: https://cloudscape.design/patterns/general/help-system/ (fetched 2026-09-24)
...
The header for the page and sections, as well as labels for [form fields](../../components/form-field/guidelines.md) and [key-value pairs](../../components/key-value-pairs/guidelines.md) . Headers explain the subject or task in a concise manner.
...
The second step of the ramp is content in the [help panel](../../components/help-panel/guidelines.md) , which extends the UI text on the page. The help panel content provides information that helps users understand concepts more fully, make good decisions, and complete tasks quickly without leaving the console for external information. This step is explicitly organized to focus on either the page, a specific section, or a specific element.

A A A B
#### A. Info links

- Info links are the triggers that open the help panel and display the corresponding content.
- An info link should always be anchored to [headers](../../components/header/guidelines.md)   or [form field labels](../../components/form-field/guidelines.md)  .
...
- [External links](../../components/link/guidelines.md)   to relevant service documentation. These links may be used with information in transitional elements like [alerts](../../components/alert/guidelines.md)   , [flashes](../../components/flashbar/guidelines.md)   , and [modals](../../components/modal/guidelines.md)  .
...
- Display page-level help content as the default [help panel](../../components/help-panel/guidelines.md)   content.
- Always include a page-level info link except for service homepage, even if it is the only one available on the page.
- In a multistep create flow, include the [help panel](../../components/help-panel/guidelines.md)   in every step.
- The [help panel](../../components/help-panel/guidelines.md)   content should change when the user has either triggered an info link on the page or navigated to a new page.
- When the user closes the [help panel](../../components/help-panel/guidelines.md)   and later reopens it within the same page view, the content should remain the same as what was previously shown. The content should not automatically switch back to the default content.
...
- Don't use the stand-alone learn more links on pages that also have help panel content unless the link is used within a transitional [alert](../../components/alert/guidelines.md)   , [flash](../../components/flashbar/guidelines.md)   , or [modal](../../components/modal/guidelines.md)  .
- Don't include an empty [help panel](../../components/help-panel/guidelines.md)   on the page.
...
- For [detail pages](../resource-management/details.md)   , [table views](../resource-management/view/table-view.md)   , and [card views](../resource-management/view/card-view.md)   , start the header with a noun to describe the subject of the page.
- For [create](../resource-management/create.md)   or [edit resource](../resource-management/edit.md)   flows, start the header with a verb to describe the primary action.
...
- Follow the writing guidelines for [inputs](../../components/input/guidelines.md)  .
...
- Follow the writing guidelines for [info links](../../components/link/guidelines.md)  .
...
- Follow the accessibility guidelines for [links](../../components/link/guidelines.md)  .

#### Help panel

- Follow the accessibility guidelines for [help panel](../../components/help-panel/guidelines.md)  .
