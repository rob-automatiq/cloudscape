...
> Source: https://cloudscape.design/patterns/general/secondary-panels/ (fetched 2026-09-24)
...
This article aims to provide an explanation for the multiple types of secondary panels that the system provides. These panels include the Help Panel, Drawer, and Split Panel. Each of these panels lives on the right-hand side of the screen, and provides a distinct purpose, as outlined below. The Tutorial Panel is an additional secondary panel, but always lives within the Help Panel. Read more about the [tutorial panel here](../../components/tutorial-panel/guidelines.md) . Note that SideNavigation, which is a panel that exists on the left-hand side of the screen, is not included here. You can read more about SideNavigation in the [side navigation](service-navigation/side-navigation.md) pattern article.
...
The help panel allows users to easily and quickly access help content within the interface and current workflow. Learn more about the [help panel](../../components/help-panel/guidelines.md) , or the overall [help system](help-system.md) . The help panel should always be first in vertical order, when multiple panels are provided. Follow the guidelines for the [AppLayout drawers](../../components/app-layout/guidelines.md).
...
The trigger bar contains the triggers for all secondary panels. The trigger bar is configured via the `drawers` and `splitPanel` slots in the [AppLayout](../../components/app-layout/guidelines.md).
...
[View Documentation](../../components/drawer/guidelines.md)

### Tutorial panel

The tutorial panel houses contextual [Hands-on tutorials](onboarding/hands-on-tutorials.md) that help users learn how to use an application.
...
[View Documentation](../resource-management/view/split-view.md)
...
[View Documentation](onboarding/hands-on-tutorials.md)
