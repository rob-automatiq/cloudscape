...
> Source: https://cloudscape.design/patterns/general/service-dashboard/dashboard-items/ (fetched 2026-09-24)
...
Dashboard items are self contained UI elements that address specific customer needs, such as navigating to a resource, monitor resources status, or viewing a costs summary.
 ...
 [View demo](https://cloudscape.design/examples/react/dashboard.html) [Configurable dashboard demo](https://cloudscape.design/examples/react/configurable-dashboard.html)
## Building blocks
...
**Additional actions **
You can group additional actions under an [icon dropdown button](../../../components/button-dropdown/guidelines.md).
...
- For information about creating charts, refer to the [data visualization](../data-vis.md)   guidelines and our  

 [data visualization components](../../../components/charts/guidelines.md)  .
...
This provides the ability for users to add an item to the layout. Follow the guidelines for [drag and drop](configurable-dashboard.md).
...
For more information refer to the [configurable dashboard](configurable-dashboard.md) pattern, and [board items](../../../components/board-item/guidelines.md).
...
- #### Responsiveness
  ...
  The content area should respond to become a 1 column grid on smaller breakpoint with content spanning 100% of the available width. More information on responsive behavior can be found in [Responsive design](../../../foundation/core-principles/responsive-design.md)  .
- #### Height

  Static: The height of dashboard items are defined by its content.  

  Configurable: The height of dashboard items has predefined height increments based on the grid. When adding content select the height that best fits the content and set as a default. This is then adjustable by the user. See [board item](../../../components/board/guidelines.md)   and the [dashboard demo](https://cloudscape.design/examples/react/dashboard.html)   for more information.  
...
[View Documentation](../../../components/board-item/guidelines.md)
...
[View Documentation](../data-vis.md)
