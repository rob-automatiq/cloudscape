...
> Source: https://cloudscape.design/patterns/general/service-dashboard/static-dashboard/ (fetched 2026-09-24)
...
A B C C D F A B C C The content of your dashboard page should be distributed following a hierarchical order of importance so that it conveys the key information of your service in a simple format. For an example of a dashboard, see our demo [service dashboard](https://cloudscape.design/examples/react/dashboard.html).
...
Use the middle area of the page to display data that provides context to the top page insights, via [dashboard items](dashboard-items.md) . Users can monitor the service status and investigate to perform issue resolution.
...
For information about creating charts, see the [data visualization](../data-vis.md) guidelines and our [data visualization](../../../components/charts/guidelines.md) components.
...
- To define the format for the data you're going to display, begin with your user's needs, and then choose the appropriate data representation type according to its purpose. Follow the guidelines for [data visualization](../data-vis.md)  .
