...
> Source: https://cloudscape.design/patterns/general/service-navigation/top-navigation/ (fetched 2026-09-24)
...
Top navigation provides global controls that help users use the product or service. It's comprised of a collection of global functionalities that are separate from the product's structural navigation.
 ...
 [View demo](https://cloudscape.design/examples/react/non-console.html)
## Key UX concepts

The top navigation should be organized to support the user's global navigation requirements. It can be used on its own or paired with the [side navigation](../../../components/side-navigation/guidelines.md) component.
...
Use a [search input](../../../components/input/guidelines.md) or [autosuggest](../../../components/autosuggest/guidelines.md) component to provide the global search for the service. Use the autosuggest component when you can provide search suggestions for quick access to relevant result.
...
Use an icon button with a [settings icon](../../../foundation/visual-foundation/iconography.md) to access global service settings.
...
Use a link button with the [user profile icon](../../../foundation/visual-foundation/iconography.md) supported with the user name or id to link to the user and or account management options.
...
The top navigation component comes with integrated responsive behavior. To see a real-life example, view the [demo](https://cloudscape.design/examples/react/non-console.html) and resize the screen to see the responsive behavior.

More information on the responsive behavior can be found in the [top navigation usage guidelines](../../../components/top-navigation/guidelines.md).
...
- Don't persist all of your services controls on smaller screen sizes.
- Don't prevent too many controls from being moved into the overflow menu.
...
[View Documentation](top-navigation.md)

### Button

Allows users to initiate actions in the user interface.

[View Documentation](../../../components/button/guidelines.md)
