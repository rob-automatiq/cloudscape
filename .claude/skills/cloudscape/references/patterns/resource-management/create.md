...
> Source: https://cloudscape.design/patterns/resource-management/create/ (fetched 2026-09-24)
...
[View Documentation](create/single-page-create.md)
...
[View Documentation](create/multi-page-create.md)
...
[View Documentation](create/sub-resource-create.md)
...
Sub-resources are either dependencies or optional enhancements used to complete the parent resource creation. For example, adding roles, policies, or security groups to an EC2 instance. These can be selected from existing options or, created and then added. Sub-resources may be owned by the same service or require cross-service creation. Follow the guidelines for [sub-resource create](create/sub-resource-create.md).
