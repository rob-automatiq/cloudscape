...
> Source: https://cloudscape.design/patterns/resource-management/details/details-page/ (fetched 2026-09-24)

On a details page, users can view at a glance all the available information about a single resource.

 [View demo](https://cloudscape.design/examples/react/details.html)
## Building blocks
...
Place the most relevant information about the resource in this container. To organize content, use [key-value pairs](../../../components/key-value-pairs/guidelines.md).
...
Navigation is open by default on details pages. For more information about structuring side navigation content, follow the guidelines for [side navigation](../../general/service-navigation/side-navigation.md).

## General guidelines

### Do

- Use containers to group your content into meaningful sections. Reflect the [creation flow](../create.md)   in your information grouping.
...
- Don't use containers for very long resource lists (more than 10 items). Instead, use a [details page as a hub](details-page-as-hub.md)   pattern.
...
- Follow the writing guidelines for [breadcrumbs](../../../components/breadcrumb-group/guidelines.md)  .
...
- Follow the writing guidelines for [containers](../../../components/container/guidelines.md)  .
