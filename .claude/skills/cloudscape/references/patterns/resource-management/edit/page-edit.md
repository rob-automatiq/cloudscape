...
> Source: https://cloudscape.design/patterns/resource-management/edit/page-edit/ (fetched 2026-09-24)

Use the page edit pattern when you want users to manage an item by editing its properties and configuration in bulk.

 [View demo](https://cloudscape.design/examples/react/edit.html)
## Key UX concepts
...
When building the edit page, offer the same type of flow used for the [resource creation](../create.md) , a [single page](../create/single-page-create.md) edit, or a [multipage](../create/multi-page-create.md) edit. The order of the input fields displayed in the form should reflect the same order of the input field displayed in the create resource form.
...
Most often used for *client-side * validation, which processes information and provides feedback, before* * the form is sent. This feedback is presented as [error text](../../../components/form-field/guidelines.md) on individual form fields.
...
Most often used for *server-side * validation, which processes information after* * the form is submitted, and returns either a success or failure. This [feedback](../../general/user-feedback.md) is presented in one of two ways: either as a page level [alert](../../../components/alert/guidelines.md) above the form's action buttons (in the case of a recoverable failure), or a [flashbar](../../../components/flashbar/guidelines.md) on the page following submission (in the case of success or immutable failure).
...
Users can exit the edit page via Save changes button even if no changes have been made. In this case, users are redirected to the page where the edit flow was initiated and an info [flashbar](../../../components/flashbar/guidelines.md) provides feedback that no changes were submitted.
...
- Don't disable the primary button, even if the user has not completed the required inputs. Perform [field validation](../../general/errors/validation.md)   instead.
...
- Use the same resource card header titles from the [create flow](../create/single-page-create.md)  .

#### Additional expandable sections

- Follow the writing guidelines for [create flow](../create/single-page-create.md)  .
...
- Follow the writing guidelines for placeholders in [inputs](../../../components/input/guidelines.md)  .
...
- Follow the writing guidelines for [buttons](../../../components/button/guidelines.md)   and [form](../../../components/form/guidelines.md)   actions.

#### Flashbar

- For success and error messages, follow the guidelines for [flashbar](../../../components/flashbar/guidelines.md)  .
