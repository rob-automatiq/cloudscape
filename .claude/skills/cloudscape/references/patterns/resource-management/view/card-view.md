...
> Source: https://cloudscape.design/patterns/resource-management/view/card-view/ (fetched 2026-09-24)
...
A collection of resources represented as cards. It's effective for glancing at small sets of similar resources with text, numerical, and imagery data sets.
 ...
 [View demo](https://cloudscape.design/examples/react/cards.html)
## Key UX concepts
...
- #### Error state
  ...
  Cards view in state when a problem occurred fetching user resources. Supported with a [flash message](../../../components/flashbar/guidelines.md)   pattern to notify the user in case of request timed-out or no access.
...
Use the "full-page" `variant` of the [cards](../../../components/cards/guidelines.md) component for this pattern.
...
- Each card links to the [details view](../details.md)   so users can access more detailed information about the resource.
...
- Cards are dedicated to resource collection only. Use the [container](../../../components/container/guidelines.md)   component with media to present a card-like container with an image.
...
- Don't use the [content layout](../../../components/content-layout/guidelines.md)   component on this type of page. Instead, use the "full-page" `variant`   of the [cards](../../../components/cards/guidelines.md)   component to implement this pattern.
